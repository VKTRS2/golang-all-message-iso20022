...
func (r *RedemptionOrderCancellationRequestV04) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *RedemptionOrderCancellationRequestV04) AddPoolReference() *model.AdditionalReference9 {
	r.PoolReference = new(model.AdditionalReference9)
	return r.PoolReference
}

func (r *RedemptionOrderCancellationRequestV04) AddPreviousReference() *model.AdditionalReference8 {
...
func (r *RedemptionOrderCancellationRequestV04) AddOrderReferences() *model.InvestmentFundOrder9 {
...
func (r *RedemptionOrderCancellationRequestV04) AddCopyDetails() *model.CopyInformation4 {
