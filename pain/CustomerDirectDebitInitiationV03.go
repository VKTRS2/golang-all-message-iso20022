...
type CustomerDirectDebitInitiationV03 struct {
	...
	PaymentInformation []*model.PaymentInstruction7 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerDirectDebitInitiationV03) AddGroupHeader() *model.GroupHeader55 {
	c.GroupHeader = new(model.GroupHeader55)
	return c.GroupHeader
}

func (c *CustomerDirectDebitInitiationV03) AddPaymentInformation() *model.PaymentInstruction7 {
	newValue := new(model.PaymentInstruction7)
...
func (c *CustomerDirectDebitInitiationV03) AddSupplementaryData() *model.SupplementaryData1 {
