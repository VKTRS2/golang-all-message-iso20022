...
type CustomerCreditTransferInitiationV03 struct {
	...
	GroupHeader *model.GroupHeader32 `xml:"GrpHdr"`
	...
	PaymentInformation []*model.PaymentInstructionInformation3 `xml:"PmtInf"`
}

func (c *CustomerCreditTransferInitiationV03) AddGroupHeader() *model.GroupHeader32 {
	c.GroupHeader = new(model.GroupHeader32)
	return c.GroupHeader
}

func (c *CustomerCreditTransferInitiationV03) AddPaymentInformation() *model.PaymentInstructionInformation3 {
	newValue := new(model.PaymentInstructionInformation3)
