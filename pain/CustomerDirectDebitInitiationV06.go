...
type CustomerDirectDebitInitiationV06 struct {
	...
	PaymentInformation []*model.PaymentInstruction18 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerDirectDebitInitiationV06) AddGroupHeader() *model.GroupHeader55 {
	c.GroupHeader = new(model.GroupHeader55)
	return c.GroupHeader
}

func (c *CustomerDirectDebitInitiationV06) AddPaymentInformation() *model.PaymentInstruction18 {
	newValue := new(model.PaymentInstruction18)
...
func (c *CustomerDirectDebitInitiationV06) AddSupplementaryData() *model.SupplementaryData1 {
