...
type CustomerPaymentReversalV03 struct {
	...
	OriginalPaymentInformationAndReversal []*model.OriginalPaymentInstruction2 `xml:"OrgnlPmtInfAndRvsl,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentReversalV03) AddGroupHeader() *model.GroupHeader56 {
	c.GroupHeader = new(model.GroupHeader56)
	return c.GroupHeader
}

func (c *CustomerPaymentReversalV03) AddOriginalGroupInformation() *model.OriginalGroupHeader3 {
	c.OriginalGroupInformation = new(model.OriginalGroupHeader3)
	return c.OriginalGroupInformation
}

func (c *CustomerPaymentReversalV03) AddOriginalPaymentInformationAndReversal() *model.OriginalPaymentInstruction2 {
	newValue := new(model.OriginalPaymentInstruction2)
...
func (c *CustomerPaymentReversalV03) AddSupplementaryData() *model.SupplementaryData1 {
