...
type CreditorPaymentActivationRequestV06 struct {
	...
	PaymentInformation []*model.PaymentInstruction23 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CreditorPaymentActivationRequestV06) AddGroupHeader() *model.GroupHeader45 {
	c.GroupHeader = new(model.GroupHeader45)
	return c.GroupHeader
}

func (c *CreditorPaymentActivationRequestV06) AddPaymentInformation() *model.PaymentInstruction23 {
	newValue := new(model.PaymentInstruction23)
...
func (c *CreditorPaymentActivationRequestV06) AddSupplementaryData() *model.SupplementaryData1 {
