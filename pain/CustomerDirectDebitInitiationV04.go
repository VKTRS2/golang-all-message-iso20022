...
type CustomerDirectDebitInitiationV04 struct {
	...
	PaymentInformation []*model.PaymentInstruction10 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerDirectDebitInitiationV04) AddGroupHeader() *model.GroupHeader55 {
	c.GroupHeader = new(model.GroupHeader55)
	return c.GroupHeader
}

func (c *CustomerDirectDebitInitiationV04) AddPaymentInformation() *model.PaymentInstruction10 {
	newValue := new(model.PaymentInstruction10)
...
func (c *CustomerDirectDebitInitiationV04) AddSupplementaryData() *model.SupplementaryData1 {
