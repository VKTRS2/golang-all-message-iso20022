...
type CustomerCreditTransferInitiationV08 struct {
	...
	PaymentInformation []*model.PaymentInstruction22 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerCreditTransferInitiationV08) AddGroupHeader() *model.GroupHeader48 {
	c.GroupHeader = new(model.GroupHeader48)
	return c.GroupHeader
}

func (c *CustomerCreditTransferInitiationV08) AddPaymentInformation() *model.PaymentInstruction22 {
	newValue := new(model.PaymentInstruction22)
...
func (c *CustomerCreditTransferInitiationV08) AddSupplementaryData() *model.SupplementaryData1 {
