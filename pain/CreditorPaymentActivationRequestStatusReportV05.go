...
type CreditorPaymentActivationRequestStatusReportV05 struct {
	...
	OriginalPaymentInformationAndStatus []*model.OriginalPaymentInstruction19 `xml:"OrgnlPmtInfAndSts,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CreditorPaymentActivationRequestStatusReportV05) AddGroupHeader() *model.GroupHeader46 {
	c.GroupHeader = new(model.GroupHeader46)
	return c.GroupHeader
}

func (c *CreditorPaymentActivationRequestStatusReportV05) AddOriginalGroupInformationAndStatus() *model.OriginalGroupInformation25 {
	c.OriginalGroupInformationAndStatus = new(model.OriginalGroupInformation25)
	return c.OriginalGroupInformationAndStatus
}

func (c *CreditorPaymentActivationRequestStatusReportV05) AddOriginalPaymentInformationAndStatus() *model.OriginalPaymentInstruction19 {
	newValue := new(model.OriginalPaymentInstruction19)
...
func (c *CreditorPaymentActivationRequestStatusReportV05) AddSupplementaryData() *model.SupplementaryData1 {
