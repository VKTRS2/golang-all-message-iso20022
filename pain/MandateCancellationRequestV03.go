...
type MandateCancellationRequestV03 struct {
	...
	UnderlyingCancellationDetails []*model.MandateCancellation3 `xml:"UndrlygCxlDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateCancellationRequestV03) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateCancellationRequestV03) AddUnderlyingCancellationDetails() *model.MandateCancellation3 {
	newValue := new(model.MandateCancellation3)
...
func (m *MandateCancellationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
