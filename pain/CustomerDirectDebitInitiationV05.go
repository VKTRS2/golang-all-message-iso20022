...
type CustomerDirectDebitInitiationV05 struct {
	...
	GroupHeader *model.GroupHeader55 `xml:"GrpHdr"`
	...
	PaymentInformation []*model.PaymentInstruction15 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerDirectDebitInitiationV05) AddGroupHeader() *model.GroupHeader55 {
	c.GroupHeader = new(model.GroupHeader55)
	return c.GroupHeader
}

func (c *CustomerDirectDebitInitiationV05) AddPaymentInformation() *model.PaymentInstruction15 {
	newValue := new(model.PaymentInstruction15)
...
func (c *CustomerDirectDebitInitiationV05) AddSupplementaryData() *model.SupplementaryData1 {
