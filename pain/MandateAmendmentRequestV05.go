...
type MandateAmendmentRequestV05 struct {
	...
	UnderlyingAmendmentDetails []*model.MandateAmendment5 `xml:"UndrlygAmdmntDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateAmendmentRequestV05) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateAmendmentRequestV05) AddUnderlyingAmendmentDetails() *model.MandateAmendment5 {
	newValue := new(model.MandateAmendment5)
...
func (m *MandateAmendmentRequestV05) AddSupplementaryData() *model.SupplementaryData1 {
