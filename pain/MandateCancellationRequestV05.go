...
type MandateCancellationRequestV05 struct {
	...
	UnderlyingCancellationDetails []*model.MandateCancellation5 `xml:"UndrlygCxlDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateCancellationRequestV05) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateCancellationRequestV05) AddUnderlyingCancellationDetails() *model.MandateCancellation5 {
	newValue := new(model.MandateCancellation5)
...
func (m *MandateCancellationRequestV05) AddSupplementaryData() *model.SupplementaryData1 {
