...
type MandateInitiationRequestV04 struct {
	...
	Mandate []*model.Mandate7 `xml:"Mndt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateInitiationRequestV04) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateInitiationRequestV04) AddMandate() *model.Mandate7 {
	newValue := new(model.Mandate7)
...
func (m *MandateInitiationRequestV04) AddSupplementaryData() *model.SupplementaryData1 {
