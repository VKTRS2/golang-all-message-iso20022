...
type CustomerPaymentStatusReportV07 struct {
	...
	OriginalPaymentInformationAndStatus []*model.OriginalPaymentInstruction18 `xml:"OrgnlPmtInfAndSts,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentStatusReportV07) AddGroupHeader() *model.GroupHeader52 {
	c.GroupHeader = new(model.GroupHeader52)
	return c.GroupHeader
}

func (c *CustomerPaymentStatusReportV07) AddOriginalGroupInformationAndStatus() *model.OriginalGroupHeader1 {
	c.OriginalGroupInformationAndStatus = new(model.OriginalGroupHeader1)
	return c.OriginalGroupInformationAndStatus
}

func (c *CustomerPaymentStatusReportV07) AddOriginalPaymentInformationAndStatus() *model.OriginalPaymentInstruction18 {
	newValue := new(model.OriginalPaymentInstruction18)
...
func (c *CustomerPaymentStatusReportV07) AddSupplementaryData() *model.SupplementaryData1 {
