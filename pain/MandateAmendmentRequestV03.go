...
type MandateAmendmentRequestV03 struct {
	...
	UnderlyingAmendmentDetails []*model.MandateAmendment3 `xml:"UndrlygAmdmntDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateAmendmentRequestV03) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateAmendmentRequestV03) AddUnderlyingAmendmentDetails() *model.MandateAmendment3 {
	newValue := new(model.MandateAmendment3)
...
func (m *MandateAmendmentRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
