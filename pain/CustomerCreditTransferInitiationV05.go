...
type CustomerCreditTransferInitiationV05 struct {
	...
	PaymentInformation []*model.PaymentInstruction9 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerCreditTransferInitiationV05) AddGroupHeader() *model.GroupHeader48 {
	c.GroupHeader = new(model.GroupHeader48)
	return c.GroupHeader
}

func (c *CustomerCreditTransferInitiationV05) AddPaymentInformation() *model.PaymentInstruction9 {
	newValue := new(model.PaymentInstruction9)
...
func (c *CustomerCreditTransferInitiationV05) AddSupplementaryData() *model.SupplementaryData1 {
