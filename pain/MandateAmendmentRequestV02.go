...
type MandateAmendmentRequestV02 struct {
	...
	UnderlyingAmendmentDetails *model.MandateAmendment2 `xml:"UndrlygAmdmntDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateAmendmentRequestV02) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateAmendmentRequestV02) AddUnderlyingAmendmentDetails() *model.MandateAmendment2 {
	m.UnderlyingAmendmentDetails = new(model.MandateAmendment2)
	return m.UnderlyingAmendmentDetails
}

func (m *MandateAmendmentRequestV02) AddSupplementaryData() *model.SupplementaryData1 {
