...
type CustomerPaymentStatusReportV04 struct {
	...
	OriginalPaymentInformationAndStatus []*model.OriginalPaymentInstruction1 `xml:"OrgnlPmtInfAndSts,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentStatusReportV04) AddGroupHeader() *model.GroupHeader52 {
	c.GroupHeader = new(model.GroupHeader52)
	return c.GroupHeader
}

func (c *CustomerPaymentStatusReportV04) AddOriginalGroupInformationAndStatus() *model.OriginalGroupHeader1 {
	c.OriginalGroupInformationAndStatus = new(model.OriginalGroupHeader1)
	return c.OriginalGroupInformationAndStatus
}

func (c *CustomerPaymentStatusReportV04) AddOriginalPaymentInformationAndStatus() *model.OriginalPaymentInstruction1 {
	newValue := new(model.OriginalPaymentInstruction1)
...
func (c *CustomerPaymentStatusReportV04) AddSupplementaryData() *model.SupplementaryData1 {
