...
type CustomerCreditTransferInitiationV07 struct {
	...
	PaymentInformation []*model.PaymentInstruction20 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerCreditTransferInitiationV07) AddGroupHeader() *model.GroupHeader48 {
	c.GroupHeader = new(model.GroupHeader48)
	return c.GroupHeader
}

func (c *CustomerCreditTransferInitiationV07) AddPaymentInformation() *model.PaymentInstruction20 {
	newValue := new(model.PaymentInstruction20)
...
func (c *CustomerCreditTransferInitiationV07) AddSupplementaryData() *model.SupplementaryData1 {
