...
type CustomerDirectDebitInitiationV07 struct {
	...
	PaymentInformation []*model.PaymentInstruction21 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerDirectDebitInitiationV07) AddGroupHeader() *model.GroupHeader55 {
	c.GroupHeader = new(model.GroupHeader55)
	return c.GroupHeader
}

func (c *CustomerDirectDebitInitiationV07) AddPaymentInformation() *model.PaymentInstruction21 {
	newValue := new(model.PaymentInstruction21)
...
func (c *CustomerDirectDebitInitiationV07) AddSupplementaryData() *model.SupplementaryData1 {
