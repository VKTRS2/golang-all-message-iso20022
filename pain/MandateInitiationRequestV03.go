...
type MandateInitiationRequestV03 struct {
	...
	Mandate []*model.Mandate4 `xml:"Mndt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (m *MandateInitiationRequestV03) AddGroupHeader() *model.GroupHeader47 {
	m.GroupHeader = new(model.GroupHeader47)
	return m.GroupHeader
}

func (m *MandateInitiationRequestV03) AddMandate() *model.Mandate4 {
	newValue := new(model.Mandate4)
...
func (m *MandateInitiationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
