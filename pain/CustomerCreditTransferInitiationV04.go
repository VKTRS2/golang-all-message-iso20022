...
type CustomerCreditTransferInitiationV04 struct {
	...
	PaymentInformation []*model.PaymentInstruction6 `xml:"PmtInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerCreditTransferInitiationV04) AddGroupHeader() *model.GroupHeader48 {
	c.GroupHeader = new(model.GroupHeader48)
	return c.GroupHeader
}

func (c *CustomerCreditTransferInitiationV04) AddPaymentInformation() *model.PaymentInstruction6 {
	newValue := new(model.PaymentInstruction6)
...
func (c *CustomerCreditTransferInitiationV04) AddSupplementaryData() *model.SupplementaryData1 {
