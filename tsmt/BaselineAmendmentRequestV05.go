...
func (b *BaselineAmendmentRequestV05) AddRequestIdentification() *model.MessageIdentification1 {
	b.RequestIdentification = new(model.MessageIdentification1)
	return b.RequestIdentification
}

func (b *BaselineAmendmentRequestV05) AddTransactionIdentification() *model.SimpleIdentificationInformation {
	b.TransactionIdentification = new(model.SimpleIdentificationInformation)
	return b.TransactionIdentification
}

func (b *BaselineAmendmentRequestV05) AddSubmitterTransactionReference() *model.SimpleIdentificationInformation {
	b.SubmitterTransactionReference = new(model.SimpleIdentificationInformation)
	return b.SubmitterTransactionReference
}

func (b *BaselineAmendmentRequestV05) AddBaseline() *model.Baseline5 {
	b.Baseline = new(model.Baseline5)
	return b.Baseline
}

func (b *BaselineAmendmentRequestV05) AddBuyerContactPerson() *model.ContactIdentification1 {
...
func (b *BaselineAmendmentRequestV05) AddSellerContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV05) AddBuyerBankContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV05) AddSellerBankContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV05) AddOtherBankContactPerson() *model.ContactIdentification3 {
