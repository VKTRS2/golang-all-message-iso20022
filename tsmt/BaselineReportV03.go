...
type BaselineReportV03 struct {
	...
	ReportedLineItem *model.LineItem8 `xml:"RptdLineItm"`

	// Information on the next processing step required.
	RequestForAction *model.PendingActivity2 `xml:"ReqForActn,omitempty"`
}

func (b *BaselineReportV03) AddReportIdentification() *model.MessageIdentification1 {
	b.ReportIdentification = new(model.MessageIdentification1)
	return b.ReportIdentification
}

func (b *BaselineReportV03) AddRelatedMessageReference() *model.MessageIdentification1 {
	b.RelatedMessageReference = new(model.MessageIdentification1)
	return b.RelatedMessageReference
}

func (b *BaselineReportV03) AddReportType() *model.ReportType2 {
	b.ReportType = new(model.ReportType2)
	return b.ReportType
}

func (b *BaselineReportV03) AddTransactionIdentification() *model.SimpleIdentificationInformation {
	b.TransactionIdentification = new(model.SimpleIdentificationInformation)
	return b.TransactionIdentification
}

func (b *BaselineReportV03) AddEstablishedBaselineIdentification() *model.DocumentIdentification6 {
	b.EstablishedBaselineIdentification = new(model.DocumentIdentification6)
	return b.EstablishedBaselineIdentification
}

func (b *BaselineReportV03) AddTransactionStatus() *model.TransactionStatus4 {
	b.TransactionStatus = new(model.TransactionStatus4)
	return b.TransactionStatus
}

func (b *BaselineReportV03) AddUserTransactionReference() *model.DocumentIdentification5 {
...
func (b *BaselineReportV03) AddBuyer() *model.PartyIdentification26 {
	b.Buyer = new(model.PartyIdentification26)
	return b.Buyer
}

func (b *BaselineReportV03) AddSeller() *model.PartyIdentification26 {
	b.Seller = new(model.PartyIdentification26)
	return b.Seller
}

func (b *BaselineReportV03) AddBuyerBank() *model.BICIdentification1 {
	b.BuyerBank = new(model.BICIdentification1)
	return b.BuyerBank
}

func (b *BaselineReportV03) AddSellerBank() *model.BICIdentification1 {
	b.SellerBank = new(model.BICIdentification1)
	return b.SellerBank
}

func (b *BaselineReportV03) AddReportedLineItem() *model.LineItem8 {
	b.ReportedLineItem = new(model.LineItem8)
	return b.ReportedLineItem
}

func (b *BaselineReportV03) AddRequestForAction() *model.PendingActivity2 {
