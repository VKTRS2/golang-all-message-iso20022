...
func (b *BaselineAmendmentRequestV04) AddRequestIdentification() *model.MessageIdentification1 {
	b.RequestIdentification = new(model.MessageIdentification1)
	return b.RequestIdentification
}

func (b *BaselineAmendmentRequestV04) AddTransactionIdentification() *model.SimpleIdentificationInformation {
	b.TransactionIdentification = new(model.SimpleIdentificationInformation)
	return b.TransactionIdentification
}

func (b *BaselineAmendmentRequestV04) AddSubmitterTransactionReference() *model.SimpleIdentificationInformation {
	b.SubmitterTransactionReference = new(model.SimpleIdentificationInformation)
	return b.SubmitterTransactionReference
}

func (b *BaselineAmendmentRequestV04) AddBaseline() *model.Baseline4 {
	b.Baseline = new(model.Baseline4)
	return b.Baseline
}

func (b *BaselineAmendmentRequestV04) AddBuyerContactPerson() *model.ContactIdentification1 {
...
func (b *BaselineAmendmentRequestV04) AddSellerContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV04) AddBuyerBankContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV04) AddSellerBankContactPerson() *model.ContactIdentification1 {
	newValue := new(model.ContactIdentification1)
...
func (b *BaselineAmendmentRequestV04) AddOtherBankContactPerson() *model.ContactIdentification3 {
