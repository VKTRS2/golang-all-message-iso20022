...
type AccountManagementStatusReportV04 struct {
	...
	StatusReport *model.AccountManagementStatusAndReason3 `xml:"StsRpt"`
...
func (a *AccountManagementStatusReportV04) AddMessageIdentification() *model.MessageIdentification1 {
	a.MessageIdentification = new(model.MessageIdentification1)
	return a.MessageIdentification
}

func (a *AccountManagementStatusReportV04) AddRelatedReference() *model.AdditionalReference3 {
...
func (a *AccountManagementStatusReportV04) AddStatusReport() *model.AccountManagementStatusAndReason3 {
	a.StatusReport = new(model.AccountManagementStatusAndReason3)
	return a.StatusReport
}

func (a *AccountManagementStatusReportV04) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	a.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return a.MarketPracticeVersion
}

func (a *AccountManagementStatusReportV04) AddExtension() *model.Extension1 {
