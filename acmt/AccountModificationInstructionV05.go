...
type AccountModificationInstructionV05 struct {
	...
	InstructionDetails *model.InvestmentAccountModification1 `xml:"InstrDtls,omitempty"`
	...
	ModifiedInvestmentAccount *model.InvestmentAccount47 `xml:"ModfdInvstmtAcct,omitempty"`

	// Information related to the account related parties, for example, primary owner to be inserted, updated or deleted.
	ModifiedAccountParties []*model.AccountParties11 `xml:"ModfdAcctPties,omitempty"`
	...
	ModifiedSavingsInvestmentPlan []*model.ModificationScope25 `xml:"ModfdSvgsInvstmtPlan,omitempty"`

	// Information related to a withdrawal plan to be either inserted, updated or deleted.
	ModifiedWithdrawalInvestmentPlan []*model.ModificationScope25 `xml:"ModfdWdrwlInvstmtPlan,omitempty"`
	...
	//
	ModifiedServiceLevelAgreement []*model.ModificationScope22 `xml:"ModfdSvcLvlAgrmt,omitempty"`
...
func (a *AccountModificationInstructionV05) AddMessageIdentification() *model.MessageIdentification1 {
	a.MessageIdentification = new(model.MessageIdentification1)
	return a.MessageIdentification
}

func (a *AccountModificationInstructionV05) AddPreviousReference() *model.AdditionalReference3 {
	a.PreviousReference = new(model.AdditionalReference3)
	return a.PreviousReference
}

func (a *AccountModificationInstructionV05) AddInstructionDetails() *model.InvestmentAccountModification1 {
	a.InstructionDetails = new(model.InvestmentAccountModification1)
	return a.InstructionDetails
}

func (a *AccountModificationInstructionV05) AddInvestmentAccountSelection() *model.InvestmentAccountSelection2 {
	a.InvestmentAccountSelection = new(model.InvestmentAccountSelection2)
	return a.InvestmentAccountSelection
}

func (a *AccountModificationInstructionV05) AddModifiedInvestmentAccount() *model.InvestmentAccount47 {
	a.ModifiedInvestmentAccount = new(model.InvestmentAccount47)
	return a.ModifiedInvestmentAccount
}

func (a *AccountModificationInstructionV05) AddModifiedAccountParties() *model.AccountParties11 {
	newValue := new(model.AccountParties11)
...
func (a *AccountModificationInstructionV05) AddModifiedIntermediaries() *model.ModificationScope20 {
...
func (a *AccountModificationInstructionV05) AddModifiedPlacement() *model.ReferredAgent1 {
	a.ModifiedPlacement = new(model.ReferredAgent1)
	return a.ModifiedPlacement
}

func (a *AccountModificationInstructionV05) AddModifiedIssueAllocation() *model.ModificationScope21 {
	a.ModifiedIssueAllocation = new(model.ModificationScope21)
	return a.ModifiedIssueAllocation
}

func (a *AccountModificationInstructionV05) AddModifiedSavingsInvestmentPlan() *model.ModificationScope25 {
	newValue := new(model.ModificationScope25)
...
func (a *AccountModificationInstructionV05) AddModifiedWithdrawalInvestmentPlan() *model.ModificationScope25 {
	newValue := new(model.ModificationScope25)
...
func (a *AccountModificationInstructionV05) AddModifiedCashSettlement() *model.InvestmentFundCashSettlementInformation8 {
...
func (a *AccountModificationInstructionV05) AddModifiedServiceLevelAgreement() *model.ModificationScope22 {
	newValue := new(model.ModificationScope22)
...
func (a *AccountModificationInstructionV05) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	a.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return a.MarketPracticeVersion
}

func (a *AccountModificationInstructionV05) AddExtension() *model.Extension1 {
