...
func (a *AccountExcludedMandateMaintenanceRequestV02) AddReferences() *model.References4 {
	a.References = new(model.References4)
	return a.References
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddFrom() *model.OrganisationIdentification8 {
	a.From = new(model.OrganisationIdentification8)
	return a.From
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddContractDates() *model.AccountContract2 {
	a.ContractDates = new(model.AccountContract2)
	return a.ContractDates
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddUnderlyingMasterAgreement() *model.ContractDocument1 {
	a.UnderlyingMasterAgreement = new(model.ContractDocument1)
	return a.UnderlyingMasterAgreement
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddAccount() *model.CustomerAccountModification1 {
	a.Account = new(model.CustomerAccountModification1)
	return a.Account
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddAccountServicerIdentification() *model.BranchAndFinancialInstitutionIdentification5 {
...
func (a *AccountExcludedMandateMaintenanceRequestV02) AddOrganisation() *model.OrganisationModification1 {
	a.Organisation = new(model.OrganisationModification1)
	return a.Organisation
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddAdditionalMessageInformation() *model.AdditionalInformation5 {
	a.AdditionalMessageInformation = new(model.AdditionalInformation5)
	return a.AdditionalMessageInformation
}

func (a *AccountExcludedMandateMaintenanceRequestV02) AddDigitalSignature() *model.PartyAndSignature2 {
...
func (a *AccountExcludedMandateMaintenanceRequestV02) AddSupplementaryData() *model.SupplementaryData1 {
