...
type FIToFICustomerCreditTransferV02 struct {
	...
	GroupHeader *model.GroupHeader33 `xml:"GrpHdr"`

	// Set of elements providing information specific to the individual credit transfer(s).
	CreditTransferTransactionInformation []*model.CreditTransferTransactionInformation11 `xml:"CdtTrfTxInf"`
}

func (f *FIToFICustomerCreditTransferV02) AddGroupHeader() *model.GroupHeader33 {
	f.GroupHeader = new(model.GroupHeader33)
	return f.GroupHeader
}

func (f *FIToFICustomerCreditTransferV02) AddCreditTransferTransactionInformation() *model.CreditTransferTransactionInformation11 {
	newValue := new(model.CreditTransferTransactionInformation11)
