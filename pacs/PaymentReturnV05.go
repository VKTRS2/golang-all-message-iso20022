...
type PaymentReturnV05 struct {
	...
	TransactionInformation []*model.PaymentTransaction50 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (p *PaymentReturnV05) AddGroupHeader() *model.GroupHeader54 {
	p.GroupHeader = new(model.GroupHeader54)
	return p.GroupHeader
}

func (p *PaymentReturnV05) AddOriginalGroupInformation() *model.OriginalGroupHeader2 {
	p.OriginalGroupInformation = new(model.OriginalGroupHeader2)
	return p.OriginalGroupInformation
}

func (p *PaymentReturnV05) AddTransactionInformation() *model.PaymentTransaction50 {
	newValue := new(model.PaymentTransaction50)
...
func (p *PaymentReturnV05) AddSupplementaryData() *model.SupplementaryData1 {
