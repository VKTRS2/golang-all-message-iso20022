...
type FIToFIPaymentStatusReportV05 struct {
	...
	TransactionInformationAndStatus []*model.PaymentTransaction43 `xml:"TxInfAndSts,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentStatusReportV05) AddGroupHeader() *model.GroupHeader53 {
	f.GroupHeader = new(model.GroupHeader53)
	return f.GroupHeader
}

func (f *FIToFIPaymentStatusReportV05) AddOriginalGroupInformationAndStatus() *model.OriginalGroupHeader1 {
	f.OriginalGroupInformationAndStatus = new(model.OriginalGroupHeader1)
	return f.OriginalGroupInformationAndStatus
}

func (f *FIToFIPaymentStatusReportV05) AddTransactionInformationAndStatus() *model.PaymentTransaction43 {
	newValue := new(model.PaymentTransaction43)
...
func (f *FIToFIPaymentStatusReportV05) AddSupplementaryData() *model.SupplementaryData1 {
