...
type FIToFICustomerCreditTransferV06 struct {
	...
	CreditTransferTransactionInformation []*model.CreditTransferTransaction25 `xml:"CdtTrfTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFICustomerCreditTransferV06) AddGroupHeader() *model.GroupHeader70 {
	f.GroupHeader = new(model.GroupHeader70)
	return f.GroupHeader
}

func (f *FIToFICustomerCreditTransferV06) AddCreditTransferTransactionInformation() *model.CreditTransferTransaction25 {
	newValue := new(model.CreditTransferTransaction25)
...
func (f *FIToFICustomerCreditTransferV06) AddSupplementaryData() *model.SupplementaryData1 {
