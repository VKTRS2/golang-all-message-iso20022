...
type FIToFIPaymentReversalV06 struct {
	...
	TransactionInformation []*model.PaymentTransaction60 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentReversalV06) AddGroupHeader() *model.GroupHeader71 {
	f.GroupHeader = new(model.GroupHeader71)
	return f.GroupHeader
}

func (f *FIToFIPaymentReversalV06) AddOriginalGroupInformation() *model.OriginalGroupHeader3 {
	f.OriginalGroupInformation = new(model.OriginalGroupHeader3)
	return f.OriginalGroupInformation
}

func (f *FIToFIPaymentReversalV06) AddTransactionInformation() *model.PaymentTransaction60 {
	newValue := new(model.PaymentTransaction60)
...
func (f *FIToFIPaymentReversalV06) AddSupplementaryData() *model.SupplementaryData1 {
