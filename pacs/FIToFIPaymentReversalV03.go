...
type FIToFIPaymentReversalV03 struct {
	...
	TransactionInformation []*model.PaymentTransaction36 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentReversalV03) AddGroupHeader() *model.GroupHeader57 {
	f.GroupHeader = new(model.GroupHeader57)
	return f.GroupHeader
}

func (f *FIToFIPaymentReversalV03) AddOriginalGroupInformation() *model.OriginalGroupHeader3 {
	f.OriginalGroupInformation = new(model.OriginalGroupHeader3)
	return f.OriginalGroupInformation
}

func (f *FIToFIPaymentReversalV03) AddTransactionInformation() *model.PaymentTransaction36 {
	newValue := new(model.PaymentTransaction36)
...
func (f *FIToFIPaymentReversalV03) AddSupplementaryData() *model.SupplementaryData1 {
