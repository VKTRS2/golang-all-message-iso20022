...
type FIToFICustomerDirectDebitV04 struct {
	...
	DirectDebitTransactionInformation []*model.DirectDebitTransactionInformation14 `xml:"DrctDbtTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFICustomerDirectDebitV04) AddGroupHeader() *model.GroupHeader50 {
	f.GroupHeader = new(model.GroupHeader50)
	return f.GroupHeader
}

func (f *FIToFICustomerDirectDebitV04) AddDirectDebitTransactionInformation() *model.DirectDebitTransactionInformation14 {
	newValue := new(model.DirectDebitTransactionInformation14)
...
func (f *FIToFICustomerDirectDebitV04) AddSupplementaryData() *model.SupplementaryData1 {
