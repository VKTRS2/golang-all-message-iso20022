...
type FIToFIPaymentReversalV04 struct {
	...
	TransactionInformation []*model.PaymentTransaction45 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentReversalV04) AddGroupHeader() *model.GroupHeader57 {
	f.GroupHeader = new(model.GroupHeader57)
	return f.GroupHeader
}

func (f *FIToFIPaymentReversalV04) AddOriginalGroupInformation() *model.OriginalGroupHeader3 {
	f.OriginalGroupInformation = new(model.OriginalGroupHeader3)
	return f.OriginalGroupInformation
}

func (f *FIToFIPaymentReversalV04) AddTransactionInformation() *model.PaymentTransaction45 {
	newValue := new(model.PaymentTransaction45)
...
func (f *FIToFIPaymentReversalV04) AddSupplementaryData() *model.SupplementaryData1 {
