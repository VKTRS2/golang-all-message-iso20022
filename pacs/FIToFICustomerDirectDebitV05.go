...
type FIToFICustomerDirectDebitV05 struct {
	...
	DirectDebitTransactionInformation []*model.DirectDebitTransactionInformation17 `xml:"DrctDbtTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFICustomerDirectDebitV05) AddGroupHeader() *model.GroupHeader50 {
	f.GroupHeader = new(model.GroupHeader50)
	return f.GroupHeader
}

func (f *FIToFICustomerDirectDebitV05) AddDirectDebitTransactionInformation() *model.DirectDebitTransactionInformation17 {
	newValue := new(model.DirectDebitTransactionInformation17)
...
func (f *FIToFICustomerDirectDebitV05) AddSupplementaryData() *model.SupplementaryData1 {
