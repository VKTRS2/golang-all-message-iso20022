...
type FinancialInstitutionCreditTransferV05 struct {
	...
	CreditTransferTransactionInformation []*model.CreditTransferTransaction17 `xml:"CdtTrfTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FinancialInstitutionCreditTransferV05) AddGroupHeader() *model.GroupHeader49 {
	f.GroupHeader = new(model.GroupHeader49)
	return f.GroupHeader
}

func (f *FinancialInstitutionCreditTransferV05) AddCreditTransferTransactionInformation() *model.CreditTransferTransaction17 {
	newValue := new(model.CreditTransferTransaction17)
...
func (f *FinancialInstitutionCreditTransferV05) AddSupplementaryData() *model.SupplementaryData1 {
