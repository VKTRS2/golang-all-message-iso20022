...
type PaymentReturnV03 struct {
	...
	TransactionInformation []*model.PaymentTransaction34 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (p *PaymentReturnV03) AddGroupHeader() *model.GroupHeader54 {
	p.GroupHeader = new(model.GroupHeader54)
	return p.GroupHeader
}

func (p *PaymentReturnV03) AddOriginalGroupInformation() *model.OriginalGroupHeader2 {
	p.OriginalGroupInformation = new(model.OriginalGroupHeader2)
	return p.OriginalGroupInformation
}

func (p *PaymentReturnV03) AddTransactionInformation() *model.PaymentTransaction34 {
	newValue := new(model.PaymentTransaction34)
...
func (p *PaymentReturnV03) AddSupplementaryData() *model.SupplementaryData1 {
