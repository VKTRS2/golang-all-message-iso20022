...
type FIToFICustomerCreditTransferV05 struct {
	...
	CreditTransferTransactionInformation []*model.CreditTransferTransaction19 `xml:"CdtTrfTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFICustomerCreditTransferV05) AddGroupHeader() *model.GroupHeader49 {
	f.GroupHeader = new(model.GroupHeader49)
	return f.GroupHeader
}

func (f *FIToFICustomerCreditTransferV05) AddCreditTransferTransactionInformation() *model.CreditTransferTransaction19 {
	newValue := new(model.CreditTransferTransaction19)
...
func (f *FIToFICustomerCreditTransferV05) AddSupplementaryData() *model.SupplementaryData1 {
