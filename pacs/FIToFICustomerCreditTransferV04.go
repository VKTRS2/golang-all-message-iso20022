...
type FIToFICustomerCreditTransferV04 struct {
	...
	CreditTransferTransactionInformation []*model.CreditTransferTransaction7 `xml:"CdtTrfTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFICustomerCreditTransferV04) AddGroupHeader() *model.GroupHeader49 {
	f.GroupHeader = new(model.GroupHeader49)
	return f.GroupHeader
}

func (f *FIToFICustomerCreditTransferV04) AddCreditTransferTransactionInformation() *model.CreditTransferTransaction7 {
	newValue := new(model.CreditTransferTransaction7)
...
func (f *FIToFICustomerCreditTransferV04) AddSupplementaryData() *model.SupplementaryData1 {
