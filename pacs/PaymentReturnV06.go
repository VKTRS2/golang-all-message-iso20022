...
type PaymentReturnV06 struct {
	...
	TransactionInformation []*model.PaymentTransaction65 `xml:"TxInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (p *PaymentReturnV06) AddGroupHeader() *model.GroupHeader72 {
	p.GroupHeader = new(model.GroupHeader72)
	return p.GroupHeader
}

func (p *PaymentReturnV06) AddOriginalGroupInformation() *model.OriginalGroupHeader2 {
	p.OriginalGroupInformation = new(model.OriginalGroupHeader2)
	return p.OriginalGroupInformation
}

func (p *PaymentReturnV06) AddTransactionInformation() *model.PaymentTransaction65 {
	newValue := new(model.PaymentTransaction65)
...
func (p *PaymentReturnV06) AddSupplementaryData() *model.SupplementaryData1 {
