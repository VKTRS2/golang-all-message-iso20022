...
type FinancialInstitutionCreditTransferV04 struct {
	...
	CreditTransferTransactionInformation []*model.CreditTransferTransaction8 `xml:"CdtTrfTxInf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FinancialInstitutionCreditTransferV04) AddGroupHeader() *model.GroupHeader49 {
	f.GroupHeader = new(model.GroupHeader49)
	return f.GroupHeader
}

func (f *FinancialInstitutionCreditTransferV04) AddCreditTransferTransactionInformation() *model.CreditTransferTransaction8 {
	newValue := new(model.CreditTransferTransaction8)
...
func (f *FinancialInstitutionCreditTransferV04) AddSupplementaryData() *model.SupplementaryData1 {
