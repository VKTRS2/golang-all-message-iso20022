...
type CorporateActionInstructionCancellationRequestStatusAdviceV03 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation34 `xml:"CorpActnGnlInf"`

	// Provides information about the processing status of the instruction cancellation request.
	InstructionCancellationRequestStatus []*model.InstructionCancellationRequestStatus5Choice `xml:"InstrCxlReqSts"`
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification9 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation34 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation34)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddInstructionCancellationRequestStatus() *model.InstructionCancellationRequestStatus5Choice {
	newValue := new(model.InstructionCancellationRequestStatus5Choice)
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddCorporateActionInstruction() *model.CorporateActionOption41 {
	c.CorporateActionInstruction = new(model.CorporateActionOption41)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV03) AddSupplementaryData() *model.SupplementaryData1 {
