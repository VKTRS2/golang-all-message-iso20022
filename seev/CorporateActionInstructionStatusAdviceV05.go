...
type CorporateActionInstructionStatusAdviceV05 struct {
	...
	InstructionProcessingStatus []*model.InstructionProcessingStatus15Choice `xml:"InstrPrcgSts"`
...
func (c *CorporateActionInstructionStatusAdviceV05) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionStatusAdviceV05) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionStatusAdviceV05) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation52 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation52)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionStatusAdviceV05) AddInstructionProcessingStatus() *model.InstructionProcessingStatus15Choice {
	newValue := new(model.InstructionProcessingStatus15Choice)
...
func (c *CorporateActionInstructionStatusAdviceV05) AddCorporateActionInstruction() *model.CorporateActionOption41 {
	c.CorporateActionInstruction = new(model.CorporateActionOption41)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionStatusAdviceV05) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionStatusAdviceV05) AddSupplementaryData() *model.SupplementaryData1 {
