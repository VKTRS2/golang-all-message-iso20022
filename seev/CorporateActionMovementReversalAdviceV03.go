...
func (c *CorporateActionMovementReversalAdviceV03) AddMovementConfirmationIdentification() *model.DocumentIdentification15 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification15)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdviceV03) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionMovementReversalAdviceV03) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionMovementReversalAdviceV03) AddReversalReason() *model.CorporateActionReversalReason1 {
	c.ReversalReason = new(model.CorporateActionReversalReason1)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdviceV03) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation39 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation39)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdviceV03) AddAccountDetails() *model.AccountAndBalance4 {
	c.AccountDetails = new(model.AccountAndBalance4)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdviceV03) AddCorporateActionConfirmationDetails() *model.CorporateActionOption39 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption39)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdviceV03) AddAdditionalInformation() *model.CorporateActionNarrative4 {
	c.AdditionalInformation = new(model.CorporateActionNarrative4)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdviceV03) AddIssuerAgent() *model.PartyIdentification46Choice {
...
func (c *CorporateActionMovementReversalAdviceV03) AddPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV03) AddSubPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV03) AddSupplementaryData() *model.SupplementaryData1 {
