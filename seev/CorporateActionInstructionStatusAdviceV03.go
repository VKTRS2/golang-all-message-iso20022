...
func (c *CorporateActionInstructionStatusAdviceV03) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionStatusAdviceV03) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionStatusAdviceV03) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation34 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation34)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionStatusAdviceV03) AddInstructionProcessingStatus() *model.InstructionProcessingStatus7Choice {
...
func (c *CorporateActionInstructionStatusAdviceV03) AddCorporateActionInstruction() *model.CorporateActionOption41 {
	c.CorporateActionInstruction = new(model.CorporateActionOption41)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionStatusAdviceV03) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionStatusAdviceV03) AddSupplementaryData() *model.SupplementaryData1 {
