...
type CorporateActionInstructionStatusAdviceV04 struct {
	...
	InstructionProcessingStatus []*model.InstructionProcessingStatus12Choice `xml:"InstrPrcgSts"`
...
func (c *CorporateActionInstructionStatusAdviceV04) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionStatusAdviceV04) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionStatusAdviceV04) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation52 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation52)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionStatusAdviceV04) AddInstructionProcessingStatus() *model.InstructionProcessingStatus12Choice {
	newValue := new(model.InstructionProcessingStatus12Choice)
...
func (c *CorporateActionInstructionStatusAdviceV04) AddCorporateActionInstruction() *model.CorporateActionOption41 {
	c.CorporateActionInstruction = new(model.CorporateActionOption41)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionStatusAdviceV04) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionStatusAdviceV04) AddSupplementaryData() *model.SupplementaryData1 {
