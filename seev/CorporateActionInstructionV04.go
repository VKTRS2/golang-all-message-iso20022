...
type CorporateActionInstructionV04 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation55 `xml:"CorpActnGnlInf"`
	...
	CorporateActionInstruction *model.CorporateActionOption57 `xml:"CorpActnInstr"`
...
func (c *CorporateActionInstructionV04) AddCancelledInstructionIdentification() *model.DocumentIdentification15 {
	c.CancelledInstructionIdentification = new(model.DocumentIdentification15)
	return c.CancelledInstructionIdentification
}

func (c *CorporateActionInstructionV04) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification15 {
...
func (c *CorporateActionInstructionV04) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionInstructionV04) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionInstructionV04) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation55 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation55)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionV04) AddAccountDetails() *model.AccountAndBalance17 {
	c.AccountDetails = new(model.AccountAndBalance17)
	return c.AccountDetails
}

func (c *CorporateActionInstructionV04) AddBeneficialOwnerDetails() *model.PartyIdentification56 {
...
func (c *CorporateActionInstructionV04) AddCorporateActionInstruction() *model.CorporateActionOption57 {
	c.CorporateActionInstruction = new(model.CorporateActionOption57)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionV04) AddAdditionalInformation() *model.CorporateActionNarrative21 {
	c.AdditionalInformation = new(model.CorporateActionNarrative21)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionV04) AddSupplementaryData() *model.SupplementaryData1 {
