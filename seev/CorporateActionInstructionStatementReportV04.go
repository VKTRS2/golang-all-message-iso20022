...
type CorporateActionInstructionStatementReportV04 struct {
	...
	AccountAndStatementDetails []*model.AccountIdentification25 `xml:"AcctAndStmtDtls"`

	// Additional information that can not be captured in the structured fields and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CorporateActionInstructionStatementReportV04) AddPagination() *model.Pagination {
	c.Pagination = new(model.Pagination)
	return c.Pagination
}

func (c *CorporateActionInstructionStatementReportV04) AddStatementGeneralDetails() *model.Statement12 {
	c.StatementGeneralDetails = new(model.Statement12)
	return c.StatementGeneralDetails
}

func (c *CorporateActionInstructionStatementReportV04) AddAccountAndStatementDetails() *model.AccountIdentification25 {
	newValue := new(model.AccountIdentification25)
...
func (c *CorporateActionInstructionStatementReportV04) AddSupplementaryData() *model.SupplementaryData1 {
