...
type CorporateActionMovementConfirmationV07 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation89 `xml:"CorpActnGnlInf"`
	...
	CorporateActionConfirmationDetails *model.CorporateActionOption117 `xml:"CorpActnConfDtls"`
...
func (c *CorporateActionMovementConfirmationV07) AddNotificationIdentification() *model.DocumentIdentification31 {
	c.NotificationIdentification = new(model.DocumentIdentification31)
	return c.NotificationIdentification
}

func (c *CorporateActionMovementConfirmationV07) AddMovementPreliminaryAdviceIdentification() *model.DocumentIdentification31 {
...
func (c *CorporateActionMovementConfirmationV07) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionMovementConfirmationV07) AddOtherDocumentIdentification() *model.DocumentIdentification32 {
...
func (c *CorporateActionMovementConfirmationV07) AddEventsLinkage() *model.CorporateActionEventReference3 {
...
func (c *CorporateActionMovementConfirmationV07) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation89 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation89)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementConfirmationV07) AddAccountDetails() *model.AccountAndBalance34 {
	c.AccountDetails = new(model.AccountAndBalance34)
	return c.AccountDetails
}

func (c *CorporateActionMovementConfirmationV07) AddCorporateActionDetails() *model.CorporateAction33 {
	c.CorporateActionDetails = new(model.CorporateAction33)
	return c.CorporateActionDetails
}

func (c *CorporateActionMovementConfirmationV07) AddCorporateActionConfirmationDetails() *model.CorporateActionOption117 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption117)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementConfirmationV07) AddAdditionalInformation() *model.CorporateActionNarrative31 {
	c.AdditionalInformation = new(model.CorporateActionNarrative31)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementConfirmationV07) AddIssuerAgent() *model.PartyIdentification71Choice {
...
func (c *CorporateActionMovementConfirmationV07) AddPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionMovementConfirmationV07) AddSubPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionMovementConfirmationV07) AddSupplementaryData() *model.SupplementaryData1 {
