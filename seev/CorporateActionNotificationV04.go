...
type CorporateActionNotificationV04 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation51 `xml:"CorpActnGnlInf"`
	...
	CorporateActionDetails *model.CorporateAction10 `xml:"CorpActnDtls,omitempty"`

	// Information about the corporate action option.
	CorporateActionOptionDetails []*model.CorporateActionOption51 `xml:"CorpActnOptnDtls,omitempty"`
...
func (c *CorporateActionNotificationV04) AddPagination() *model.Pagination {
	c.Pagination = new(model.Pagination)
	return c.Pagination
}

func (c *CorporateActionNotificationV04) AddNotificationGeneralInformation() *model.CorporateActionNotification3 {
	c.NotificationGeneralInformation = new(model.CorporateActionNotification3)
	return c.NotificationGeneralInformation
}

func (c *CorporateActionNotificationV04) AddPreviousNotificationIdentification() *model.DocumentIdentification15 {
	c.PreviousNotificationIdentification = new(model.DocumentIdentification15)
	return c.PreviousNotificationIdentification
}

func (c *CorporateActionNotificationV04) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionNotificationV04) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionNotificationV04) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionNotificationV04) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation51 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation51)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionNotificationV04) AddAccountDetails() *model.AccountIdentification21Choice {
	c.AccountDetails = new(model.AccountIdentification21Choice)
	return c.AccountDetails
}

func (c *CorporateActionNotificationV04) AddIntermediateSecurity() *model.FinancialInstrumentAttributes46 {
	c.IntermediateSecurity = new(model.FinancialInstrumentAttributes46)
	return c.IntermediateSecurity
}

func (c *CorporateActionNotificationV04) AddCorporateActionDetails() *model.CorporateAction10 {
	c.CorporateActionDetails = new(model.CorporateAction10)
	return c.CorporateActionDetails
}

func (c *CorporateActionNotificationV04) AddCorporateActionOptionDetails() *model.CorporateActionOption51 {
	newValue := new(model.CorporateActionOption51)
...
func (c *CorporateActionNotificationV04) AddAdditionalInformation() *model.CorporateActionNarrative11 {
	c.AdditionalInformation = new(model.CorporateActionNarrative11)
	return c.AdditionalInformation
}

func (c *CorporateActionNotificationV04) AddIssuerAgent() *model.PartyIdentification47Choice {
...
func (c *CorporateActionNotificationV04) AddPayingAgent() *model.PartyIdentification47Choice {
	newValue := new(model.PartyIdentification47Choice)
...
func (c *CorporateActionNotificationV04) AddSubPayingAgent() *model.PartyIdentification47Choice {
	newValue := new(model.PartyIdentification47Choice)
...
func (c *CorporateActionNotificationV04) AddRegistrar() *model.PartyIdentification47Choice {
	c.Registrar = new(model.PartyIdentification47Choice)
	return c.Registrar
}

func (c *CorporateActionNotificationV04) AddResellingAgent() *model.PartyIdentification47Choice {
	newValue := new(model.PartyIdentification47Choice)
...
func (c *CorporateActionNotificationV04) AddPhysicalSecuritiesAgent() *model.PartyIdentification47Choice {
	c.PhysicalSecuritiesAgent = new(model.PartyIdentification47Choice)
	return c.PhysicalSecuritiesAgent
}

func (c *CorporateActionNotificationV04) AddDropAgent() *model.PartyIdentification47Choice {
	c.DropAgent = new(model.PartyIdentification47Choice)
	return c.DropAgent
}

func (c *CorporateActionNotificationV04) AddSolicitationAgent() *model.PartyIdentification47Choice {
	newValue := new(model.PartyIdentification47Choice)
...
func (c *CorporateActionNotificationV04) AddInformationAgent() *model.PartyIdentification47Choice {
	c.InformationAgent = new(model.PartyIdentification47Choice)
	return c.InformationAgent
}

func (c *CorporateActionNotificationV04) AddSupplementaryData() *model.SupplementaryData1 {
