...
type CorporateActionInstructionStatementReportV03 struct {
	...
	AccountAndStatementDetails []*model.AccountIdentification23 `xml:"AcctAndStmtDtls"`

	// Additional information that can not be captured in the structured fields and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CorporateActionInstructionStatementReportV03) AddPagination() *model.Pagination {
	c.Pagination = new(model.Pagination)
	return c.Pagination
}

func (c *CorporateActionInstructionStatementReportV03) AddStatementGeneralDetails() *model.Statement12 {
	c.StatementGeneralDetails = new(model.Statement12)
	return c.StatementGeneralDetails
}

func (c *CorporateActionInstructionStatementReportV03) AddAccountAndStatementDetails() *model.AccountIdentification23 {
	newValue := new(model.AccountIdentification23)
...
func (c *CorporateActionInstructionStatementReportV03) AddSupplementaryData() *model.SupplementaryData1 {
