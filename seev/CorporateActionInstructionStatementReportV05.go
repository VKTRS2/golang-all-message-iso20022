...
type CorporateActionInstructionStatementReportV05 struct {
	...
	AccountAndStatementDetails []*model.AccountIdentification33 `xml:"AcctAndStmtDtls"`

	// Additional information that can not be captured in the structured fields and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CorporateActionInstructionStatementReportV05) AddPagination() *model.Pagination {
	c.Pagination = new(model.Pagination)
	return c.Pagination
}

func (c *CorporateActionInstructionStatementReportV05) AddStatementGeneralDetails() *model.Statement47 {
	c.StatementGeneralDetails = new(model.Statement47)
	return c.StatementGeneralDetails
}

func (c *CorporateActionInstructionStatementReportV05) AddAccountAndStatementDetails() *model.AccountIdentification33 {
	newValue := new(model.AccountIdentification33)
...
func (c *CorporateActionInstructionStatementReportV05) AddSupplementaryData() *model.SupplementaryData1 {
