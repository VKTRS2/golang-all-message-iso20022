...
type CorporateActionCancellationAdviceV06 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation86 `xml:"CorpActnGnlInf"`
...
func (c *CorporateActionCancellationAdviceV06) AddCancellationAdviceGeneralInformation() *model.CorporateActionCancellation3 {
...
func (c *CorporateActionCancellationAdviceV06) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation86 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation86)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionCancellationAdviceV06) AddAccountsDetails() *model.AccountIdentification29Choice {
	c.AccountsDetails = new(model.AccountIdentification29Choice)
	return c.AccountsDetails
}

func (c *CorporateActionCancellationAdviceV06) AddCorporateActionDetails() *model.CorporateAction34 {
	c.CorporateActionDetails = new(model.CorporateAction34)
	return c.CorporateActionDetails
}

func (c *CorporateActionCancellationAdviceV06) AddIssuerAgent() *model.PartyIdentification71Choice {
...
func (c *CorporateActionCancellationAdviceV06) AddPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionCancellationAdviceV06) AddSubPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionCancellationAdviceV06) AddRegistrar() *model.PartyIdentification71Choice {
	c.Registrar = new(model.PartyIdentification71Choice)
	return c.Registrar
}

func (c *CorporateActionCancellationAdviceV06) AddResellingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionCancellationAdviceV06) AddPhysicalSecuritiesAgent() *model.PartyIdentification71Choice {
	c.PhysicalSecuritiesAgent = new(model.PartyIdentification71Choice)
	return c.PhysicalSecuritiesAgent
}

func (c *CorporateActionCancellationAdviceV06) AddDropAgent() *model.PartyIdentification71Choice {
	c.DropAgent = new(model.PartyIdentification71Choice)
	return c.DropAgent
}

func (c *CorporateActionCancellationAdviceV06) AddSolicitationAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionCancellationAdviceV06) AddInformationAgent() *model.PartyIdentification71Choice {
	c.InformationAgent = new(model.PartyIdentification71Choice)
	return c.InformationAgent
}

func (c *CorporateActionCancellationAdviceV06) AddSupplementaryData() *model.SupplementaryData1 {
