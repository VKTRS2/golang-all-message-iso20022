...
type CorporateActionInstructionCancellationRequestStatusAdviceV01 struct {
	...
	InstructionCancellationRequestStatus []*model.InstructionCancellationRequestStatus1Choice `xml:"InstrCxlReqSts"`
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddIdentification() *model.DocumentIdentification11 {
	c.Identification = new(model.DocumentIdentification11)
	return c.Identification
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification9 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation9 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation9)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddInstructionCancellationRequestStatus() *model.InstructionCancellationRequestStatus1Choice {
	newValue := new(model.InstructionCancellationRequestStatus1Choice)
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddCorporateActionInstruction() *model.CorporateActionOption9 {
	c.CorporateActionInstruction = new(model.CorporateActionOption9)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddMessageOriginator() *model.PartyIdentification10Choice {
	c.MessageOriginator = new(model.PartyIdentification10Choice)
	return c.MessageOriginator
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddMessageRecipient() *model.PartyIdentification10Choice {
	c.MessageRecipient = new(model.PartyIdentification10Choice)
	return c.MessageRecipient
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV01) AddExtension() *model.Extension2 {
