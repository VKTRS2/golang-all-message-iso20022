...
func (c *CorporateActionMovementReversalAdviceV06) AddMovementConfirmationIdentification() *model.DocumentIdentification15 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification15)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdviceV06) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionMovementReversalAdviceV06) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionMovementReversalAdviceV06) AddReversalReason() *model.CorporateActionReversalReason1 {
	c.ReversalReason = new(model.CorporateActionReversalReason1)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdviceV06) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation79 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation79)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdviceV06) AddAccountDetails() *model.AccountAndBalance4 {
	c.AccountDetails = new(model.AccountAndBalance4)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdviceV06) AddCorporateActionDetails() *model.CorporateAction13 {
	c.CorporateActionDetails = new(model.CorporateAction13)
	return c.CorporateActionDetails
}

func (c *CorporateActionMovementReversalAdviceV06) AddCorporateActionConfirmationDetails() *model.CorporateActionOption39 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption39)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdviceV06) AddAdditionalInformation() *model.CorporateActionNarrative4 {
	c.AdditionalInformation = new(model.CorporateActionNarrative4)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdviceV06) AddIssuerAgent() *model.PartyIdentification40Choice {
...
func (c *CorporateActionMovementReversalAdviceV06) AddPayingAgent() *model.PartyIdentification40Choice {
	newValue := new(model.PartyIdentification40Choice)
...
func (c *CorporateActionMovementReversalAdviceV06) AddSubPayingAgent() *model.PartyIdentification40Choice {
	newValue := new(model.PartyIdentification40Choice)
...
func (c *CorporateActionMovementReversalAdviceV06) AddSupplementaryData() *model.SupplementaryData1 {
