...
type CorporateActionMovementConfirmationV03 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation39 `xml:"CorpActnGnlInf"`

	// General information about the safekeeping account, owner and account balance.
	AccountDetails *model.AccountAndBalance16 `xml:"AcctDtls"`

	// Information about the corporate action option.
	CorporateActionConfirmationDetails *model.CorporateActionOption37 `xml:"CorpActnConfDtls"`
...
func (c *CorporateActionMovementConfirmationV03) AddNotificationIdentification() *model.DocumentIdentification15 {
	c.NotificationIdentification = new(model.DocumentIdentification15)
	return c.NotificationIdentification
}

func (c *CorporateActionMovementConfirmationV03) AddMovementPreliminaryAdviceIdentification() *model.DocumentIdentification15 {
...
func (c *CorporateActionMovementConfirmationV03) AddInstructionIdentification() *model.DocumentIdentification9 {
	c.InstructionIdentification = new(model.DocumentIdentification9)
	return c.InstructionIdentification
}

func (c *CorporateActionMovementConfirmationV03) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionMovementConfirmationV03) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionMovementConfirmationV03) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation39 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation39)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementConfirmationV03) AddAccountDetails() *model.AccountAndBalance16 {
	c.AccountDetails = new(model.AccountAndBalance16)
	return c.AccountDetails
}

func (c *CorporateActionMovementConfirmationV03) AddCorporateActionConfirmationDetails() *model.CorporateActionOption37 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption37)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementConfirmationV03) AddAdditionalInformation() *model.CorporateActionNarrative4 {
	c.AdditionalInformation = new(model.CorporateActionNarrative4)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementConfirmationV03) AddIssuerAgent() *model.PartyIdentification46Choice {
...
func (c *CorporateActionMovementConfirmationV03) AddPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementConfirmationV03) AddSubPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementConfirmationV03) AddSupplementaryData() *model.SupplementaryData1 {
