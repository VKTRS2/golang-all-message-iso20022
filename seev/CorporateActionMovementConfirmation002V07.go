...
type CorporateActionMovementConfirmation002V07 struct {
	...
	CorporateActionConfirmationDetails *model.CorporateActionOption124 `xml:"CorpActnConfDtls"`
...
func (c *CorporateActionMovementConfirmation002V07) AddNotificationIdentification() *model.DocumentIdentification37 {
	c.NotificationIdentification = new(model.DocumentIdentification37)
	return c.NotificationIdentification
}

func (c *CorporateActionMovementConfirmation002V07) AddMovementPreliminaryAdviceIdentification() *model.DocumentIdentification37 {
...
func (c *CorporateActionMovementConfirmation002V07) AddInstructionIdentification() *model.DocumentIdentification17 {
	c.InstructionIdentification = new(model.DocumentIdentification17)
	return c.InstructionIdentification
}

func (c *CorporateActionMovementConfirmation002V07) AddOtherDocumentIdentification() *model.DocumentIdentification38 {
...
func (c *CorporateActionMovementConfirmation002V07) AddEventsLinkage() *model.CorporateActionEventReference4 {
...
func (c *CorporateActionMovementConfirmation002V07) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation98 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation98)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementConfirmation002V07) AddAccountDetails() *model.AccountAndBalance38 {
	c.AccountDetails = new(model.AccountAndBalance38)
	return c.AccountDetails
}

func (c *CorporateActionMovementConfirmation002V07) AddCorporateActionDetails() *model.CorporateAction36 {
	c.CorporateActionDetails = new(model.CorporateAction36)
	return c.CorporateActionDetails
}

func (c *CorporateActionMovementConfirmation002V07) AddCorporateActionConfirmationDetails() *model.CorporateActionOption124 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption124)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementConfirmation002V07) AddAdditionalInformation() *model.CorporateActionNarrative35 {
	c.AdditionalInformation = new(model.CorporateActionNarrative35)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementConfirmation002V07) AddIssuerAgent() *model.PartyIdentification104Choice {
...
func (c *CorporateActionMovementConfirmation002V07) AddPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionMovementConfirmation002V07) AddSubPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionMovementConfirmation002V07) AddSupplementaryData() *model.SupplementaryData1 {
