...
type CorporateActionInstructionCancellationRequest002V06 struct {
	...
	InstructionIdentification *model.DocumentIdentification49 `xml:"InstrId"`

	// General information about the corporate action event.
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation104 `xml:"CorpActnGnlInf"`

	// General information about the safekeeping account and the account owner.
	AccountDetails *model.AccountIdentification39 `xml:"AcctDtls"`
...
func (c *CorporateActionInstructionCancellationRequest002V06) AddInstructionIdentification() *model.DocumentIdentification49 {
	c.InstructionIdentification = new(model.DocumentIdentification49)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionCancellationRequest002V06) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation104 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation104)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequest002V06) AddAccountDetails() *model.AccountIdentification39 {
	c.AccountDetails = new(model.AccountIdentification39)
	return c.AccountDetails
}

func (c *CorporateActionInstructionCancellationRequest002V06) AddCorporateActionInstruction() *model.CorporateActionOption128 {
	c.CorporateActionInstruction = new(model.CorporateActionOption128)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequest002V06) AddSupplementaryData() *model.SupplementaryData1 {
