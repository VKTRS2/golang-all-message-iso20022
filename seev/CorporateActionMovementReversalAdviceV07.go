...
func (c *CorporateActionMovementReversalAdviceV07) AddMovementConfirmationIdentification() *model.DocumentIdentification31 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification31)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdviceV07) AddOtherDocumentIdentification() *model.DocumentIdentification32 {
...
func (c *CorporateActionMovementReversalAdviceV07) AddEventsLinkage() *model.CorporateActionEventReference3 {
...
func (c *CorporateActionMovementReversalAdviceV07) AddReversalReason() *model.CorporateActionReversalReason3 {
	c.ReversalReason = new(model.CorporateActionReversalReason3)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdviceV07) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation89 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation89)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdviceV07) AddAccountDetails() *model.AccountAndBalance36 {
	c.AccountDetails = new(model.AccountAndBalance36)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdviceV07) AddCorporateActionDetails() *model.CorporateAction33 {
	c.CorporateActionDetails = new(model.CorporateAction33)
	return c.CorporateActionDetails
}

func (c *CorporateActionMovementReversalAdviceV07) AddCorporateActionConfirmationDetails() *model.CorporateActionOption119 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption119)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdviceV07) AddAdditionalInformation() *model.CorporateActionNarrative31 {
	c.AdditionalInformation = new(model.CorporateActionNarrative31)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdviceV07) AddIssuerAgent() *model.PartyIdentification71Choice {
...
func (c *CorporateActionMovementReversalAdviceV07) AddPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionMovementReversalAdviceV07) AddSubPayingAgent() *model.PartyIdentification71Choice {
	newValue := new(model.PartyIdentification71Choice)
...
func (c *CorporateActionMovementReversalAdviceV07) AddSupplementaryData() *model.SupplementaryData1 {
