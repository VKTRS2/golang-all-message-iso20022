...
func (c *CorporateActionMovementReversalAdviceV04) AddMovementConfirmationIdentification() *model.DocumentIdentification15 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification15)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdviceV04) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionMovementReversalAdviceV04) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionMovementReversalAdviceV04) AddReversalReason() *model.CorporateActionReversalReason1 {
	c.ReversalReason = new(model.CorporateActionReversalReason1)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdviceV04) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation50 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation50)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdviceV04) AddAccountDetails() *model.AccountAndBalance4 {
	c.AccountDetails = new(model.AccountAndBalance4)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdviceV04) AddCorporateActionConfirmationDetails() *model.CorporateActionOption39 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption39)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdviceV04) AddAdditionalInformation() *model.CorporateActionNarrative4 {
	c.AdditionalInformation = new(model.CorporateActionNarrative4)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdviceV04) AddIssuerAgent() *model.PartyIdentification46Choice {
...
func (c *CorporateActionMovementReversalAdviceV04) AddPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV04) AddSubPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV04) AddSupplementaryData() *model.SupplementaryData1 {
