...
type CorporateActionInstructionCancellationRequestV07 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation110 `xml:"CorpActnGnlInf"`
...
func (c *CorporateActionInstructionCancellationRequestV07) AddInstructionIdentification() *model.DocumentIdentification31 {
	c.InstructionIdentification = new(model.DocumentIdentification31)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionCancellationRequestV07) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation110 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation110)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequestV07) AddAccountDetails() *model.AccountIdentification31 {
	c.AccountDetails = new(model.AccountIdentification31)
	return c.AccountDetails
}

func (c *CorporateActionInstructionCancellationRequestV07) AddCorporateActionInstruction() *model.CorporateActionOption120 {
	c.CorporateActionInstruction = new(model.CorporateActionOption120)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequestV07) AddSupplementaryData() *model.SupplementaryData1 {
