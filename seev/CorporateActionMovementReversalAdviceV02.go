...
type CorporateActionMovementReversalAdviceV02 struct {
	...
	CorporateActionConfirmationDetails *model.CorporateActionOption24 `xml:"CorpActnConfDtls"`
...
func (c *CorporateActionMovementReversalAdviceV02) AddMovementConfirmationIdentification() *model.DocumentIdentification15 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification15)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdviceV02) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionMovementReversalAdviceV02) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionMovementReversalAdviceV02) AddReversalReason() *model.CorporateActionReversalReason1 {
	c.ReversalReason = new(model.CorporateActionReversalReason1)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdviceV02) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation24 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation24)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdviceV02) AddAccountDetails() *model.AccountAndBalance4 {
	c.AccountDetails = new(model.AccountAndBalance4)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdviceV02) AddCorporateActionConfirmationDetails() *model.CorporateActionOption24 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption24)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdviceV02) AddAdditionalInformation() *model.CorporateActionNarrative4 {
	c.AdditionalInformation = new(model.CorporateActionNarrative4)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdviceV02) AddIssuerAgent() *model.PartyIdentification46Choice {
...
func (c *CorporateActionMovementReversalAdviceV02) AddPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV02) AddSubPayingAgent() *model.PartyIdentification46Choice {
	newValue := new(model.PartyIdentification46Choice)
...
func (c *CorporateActionMovementReversalAdviceV02) AddSupplementaryData() *model.SupplementaryData1 {
