...
type CorporateActionInstruction002V06 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation97 `xml:"CorpActnGnlInf"`
	...
	CorporateActionInstruction *model.CorporateActionOption123 `xml:"CorpActnInstr"`
...
func (c *CorporateActionInstruction002V06) AddCancelledInstructionIdentification() *model.DocumentIdentification37 {
	c.CancelledInstructionIdentification = new(model.DocumentIdentification37)
	return c.CancelledInstructionIdentification
}

func (c *CorporateActionInstruction002V06) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification37 {
...
func (c *CorporateActionInstruction002V06) AddOtherDocumentIdentification() *model.DocumentIdentification38 {
...
func (c *CorporateActionInstruction002V06) AddEventsLinkage() *model.CorporateActionEventReference4 {
...
func (c *CorporateActionInstruction002V06) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation97 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation97)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstruction002V06) AddAccountDetails() *model.AccountAndBalance37 {
	c.AccountDetails = new(model.AccountAndBalance37)
	return c.AccountDetails
}

func (c *CorporateActionInstruction002V06) AddBeneficialOwnerDetails() *model.PartyIdentification101 {
...
func (c *CorporateActionInstruction002V06) AddCorporateActionInstruction() *model.CorporateActionOption123 {
	c.CorporateActionInstruction = new(model.CorporateActionOption123)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstruction002V06) AddAdditionalInformation() *model.CorporateActionNarrative34 {
	c.AdditionalInformation = new(model.CorporateActionNarrative34)
	return c.AdditionalInformation
}

func (c *CorporateActionInstruction002V06) AddSupplementaryData() *model.SupplementaryData1 {
