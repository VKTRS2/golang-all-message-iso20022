...
type CorporateActionInstructionV05 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation71 `xml:"CorpActnGnlInf"`
	...
	CorporateActionInstruction *model.CorporateActionOption103 `xml:"CorpActnInstr"`
...
func (c *CorporateActionInstructionV05) AddCancelledInstructionIdentification() *model.DocumentIdentification15 {
	c.CancelledInstructionIdentification = new(model.DocumentIdentification15)
	return c.CancelledInstructionIdentification
}

func (c *CorporateActionInstructionV05) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification15 {
...
func (c *CorporateActionInstructionV05) AddOtherDocumentIdentification() *model.DocumentIdentification13 {
...
func (c *CorporateActionInstructionV05) AddEventsLinkage() *model.CorporateActionEventReference1 {
...
func (c *CorporateActionInstructionV05) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation71 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation71)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionV05) AddAccountDetails() *model.AccountAndBalance17 {
	c.AccountDetails = new(model.AccountAndBalance17)
	return c.AccountDetails
}

func (c *CorporateActionInstructionV05) AddBeneficialOwnerDetails() *model.PartyIdentification56 {
...
func (c *CorporateActionInstructionV05) AddCorporateActionInstruction() *model.CorporateActionOption103 {
	c.CorporateActionInstruction = new(model.CorporateActionOption103)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionV05) AddAdditionalInformation() *model.CorporateActionNarrative21 {
	c.AdditionalInformation = new(model.CorporateActionNarrative21)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionV05) AddSupplementaryData() *model.SupplementaryData1 {
