...
type CorporateActionCancellationAdvice002V07 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation120 `xml:"CorpActnGnlInf"`
...
func (c *CorporateActionCancellationAdvice002V07) AddCancellationAdviceGeneralInformation() *model.CorporateActionCancellation4 {
...
func (c *CorporateActionCancellationAdvice002V07) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation120 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation120)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionCancellationAdvice002V07) AddAccountsDetails() *model.AccountIdentification34Choice {
	c.AccountsDetails = new(model.AccountIdentification34Choice)
	return c.AccountsDetails
}

func (c *CorporateActionCancellationAdvice002V07) AddCorporateActionDetails() *model.CorporateAction35 {
	c.CorporateActionDetails = new(model.CorporateAction35)
	return c.CorporateActionDetails
}

func (c *CorporateActionCancellationAdvice002V07) AddIssuerAgent() *model.PartyIdentification104Choice {
...
func (c *CorporateActionCancellationAdvice002V07) AddPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionCancellationAdvice002V07) AddSubPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionCancellationAdvice002V07) AddRegistrar() *model.PartyIdentification104Choice {
	c.Registrar = new(model.PartyIdentification104Choice)
	return c.Registrar
}

func (c *CorporateActionCancellationAdvice002V07) AddResellingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionCancellationAdvice002V07) AddPhysicalSecuritiesAgent() *model.PartyIdentification104Choice {
	c.PhysicalSecuritiesAgent = new(model.PartyIdentification104Choice)
	return c.PhysicalSecuritiesAgent
}

func (c *CorporateActionCancellationAdvice002V07) AddDropAgent() *model.PartyIdentification104Choice {
	c.DropAgent = new(model.PartyIdentification104Choice)
	return c.DropAgent
}

func (c *CorporateActionCancellationAdvice002V07) AddSolicitationAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionCancellationAdvice002V07) AddInformationAgent() *model.PartyIdentification104Choice {
	c.InformationAgent = new(model.PartyIdentification104Choice)
	return c.InformationAgent
}

func (c *CorporateActionCancellationAdvice002V07) AddSupplementaryData() *model.SupplementaryData1 {
