...
type CorporateActionInstructionCancellationRequestStatusAdviceV05 struct {
	...
	InstructionCancellationRequestStatus []*model.InstructionCancellationRequestStatus7Choice `xml:"InstrCxlReqSts"`
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddInstructionCancellationRequestIdentification() *model.DocumentIdentification9 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddOtherDocumentIdentification() *model.DocumentIdentification14 {
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation52 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation52)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddInstructionCancellationRequestStatus() *model.InstructionCancellationRequestStatus7Choice {
	newValue := new(model.InstructionCancellationRequestStatus7Choice)
...
func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddCorporateActionInstruction() *model.CorporateActionOption41 {
	c.CorporateActionInstruction = new(model.CorporateActionOption41)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddAdditionalInformation() *model.CorporateActionNarrative10 {
	c.AdditionalInformation = new(model.CorporateActionNarrative10)
	return c.AdditionalInformation
}

func (c *CorporateActionInstructionCancellationRequestStatusAdviceV05) AddSupplementaryData() *model.SupplementaryData1 {
