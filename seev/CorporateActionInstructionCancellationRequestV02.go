...
type CorporateActionInstructionCancellationRequestV02 struct {
	...
	CorporateActionGeneralInformation *model.CorporateActionGeneralInformation26 `xml:"CorpActnGnlInf"`

	// General information about the safekeeping account and the account owner.
	AccountDetails *model.AccountIdentification17 `xml:"AcctDtls"`

	// Information about the corporate action option.
	CorporateActionInstruction *model.CorporateActionOption21 `xml:"CorpActnInstr"`
...
func (c *CorporateActionInstructionCancellationRequestV02) AddInstructionIdentification() *model.DocumentIdentification15 {
	c.InstructionIdentification = new(model.DocumentIdentification15)
	return c.InstructionIdentification
}

func (c *CorporateActionInstructionCancellationRequestV02) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation26 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation26)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionInstructionCancellationRequestV02) AddAccountDetails() *model.AccountIdentification17 {
	c.AccountDetails = new(model.AccountIdentification17)
	return c.AccountDetails
}

func (c *CorporateActionInstructionCancellationRequestV02) AddCorporateActionInstruction() *model.CorporateActionOption21 {
	c.CorporateActionInstruction = new(model.CorporateActionOption21)
	return c.CorporateActionInstruction
}

func (c *CorporateActionInstructionCancellationRequestV02) AddSupplementaryData() *model.SupplementaryData1 {
