...
func (c *CorporateActionMovementReversalAdvice002V08) AddMovementConfirmationIdentification() *model.DocumentIdentification37 {
	c.MovementConfirmationIdentification = new(model.DocumentIdentification37)
	return c.MovementConfirmationIdentification
}

func (c *CorporateActionMovementReversalAdvice002V08) AddOtherDocumentIdentification() *model.DocumentIdentification38 {
...
func (c *CorporateActionMovementReversalAdvice002V08) AddEventsLinkage() *model.CorporateActionEventReference4 {
...
func (c *CorporateActionMovementReversalAdvice002V08) AddReversalReason() *model.CorporateActionReversalReason4 {
	c.ReversalReason = new(model.CorporateActionReversalReason4)
	return c.ReversalReason
}

func (c *CorporateActionMovementReversalAdvice002V08) AddCorporateActionGeneralInformation() *model.CorporateActionGeneralInformation118 {
	c.CorporateActionGeneralInformation = new(model.CorporateActionGeneralInformation118)
	return c.CorporateActionGeneralInformation
}

func (c *CorporateActionMovementReversalAdvice002V08) AddAccountDetails() *model.AccountAndBalance40 {
	c.AccountDetails = new(model.AccountAndBalance40)
	return c.AccountDetails
}

func (c *CorporateActionMovementReversalAdvice002V08) AddCorporateActionDetails() *model.CorporateAction36 {
	c.CorporateActionDetails = new(model.CorporateAction36)
	return c.CorporateActionDetails
}

func (c *CorporateActionMovementReversalAdvice002V08) AddCorporateActionConfirmationDetails() *model.CorporateActionOption126 {
	c.CorporateActionConfirmationDetails = new(model.CorporateActionOption126)
	return c.CorporateActionConfirmationDetails
}

func (c *CorporateActionMovementReversalAdvice002V08) AddAdditionalInformation() *model.CorporateActionNarrative35 {
	c.AdditionalInformation = new(model.CorporateActionNarrative35)
	return c.AdditionalInformation
}

func (c *CorporateActionMovementReversalAdvice002V08) AddIssuerAgent() *model.PartyIdentification104Choice {
...
func (c *CorporateActionMovementReversalAdvice002V08) AddPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionMovementReversalAdvice002V08) AddSubPayingAgent() *model.PartyIdentification104Choice {
	newValue := new(model.PartyIdentification104Choice)
...
func (c *CorporateActionMovementReversalAdvice002V08) AddSupplementaryData() *model.SupplementaryData1 {
