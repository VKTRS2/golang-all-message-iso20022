...
type SecuritiesStatementQueryV05 struct {
	...
	AdditionalQueryParameters []*model.AdditionalQueryParameters9 `xml:"AddtlQryParams,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesStatementQueryV05) AddStatementRequested() *model.DocumentNumber1 {
	s.StatementRequested = new(model.DocumentNumber1)
	return s.StatementRequested
}

func (s *SecuritiesStatementQueryV05) AddStatementGeneralDetails() *model.Statement16 {
	s.StatementGeneralDetails = new(model.Statement16)
	return s.StatementGeneralDetails
}

func (s *SecuritiesStatementQueryV05) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesStatementQueryV05) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesStatementQueryV05) AddAdditionalQueryParameters() *model.AdditionalQueryParameters9 {
	newValue := new(model.AdditionalQueryParameters9)
...
func (s *SecuritiesStatementQueryV05) AddSupplementaryData() *model.SupplementaryData1 {
