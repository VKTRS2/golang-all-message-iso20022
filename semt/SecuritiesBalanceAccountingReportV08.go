...
type SecuritiesBalanceAccountingReportV08 struct {
	...
	BalanceForAccount []*model.AggregateBalanceInformation26 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification38 `xml:"SubAcctDtls,omitempty"`
...
func (s *SecuritiesBalanceAccountingReportV08) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceAccountingReportV08) AddStatementGeneralDetails() *model.Statement20 {
	s.StatementGeneralDetails = new(model.Statement20)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceAccountingReportV08) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceAccountingReportV08) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceAccountingReportV08) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceAccountingReportV08) AddIntermediaryInformation() *model.Intermediary23 {
...
func (s *SecuritiesBalanceAccountingReportV08) AddBalanceForAccount() *model.AggregateBalanceInformation26 {
	newValue := new(model.AggregateBalanceInformation26)
...
func (s *SecuritiesBalanceAccountingReportV08) AddSubAccountDetails() *model.SubAccountIdentification38 {
	newValue := new(model.SubAccountIdentification38)
...
func (s *SecuritiesBalanceAccountingReportV08) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
	s.AccountBaseCurrencyTotalAmounts = new(model.TotalValueInPageAndStatement2)
	return s.AccountBaseCurrencyTotalAmounts
}

func (s *SecuritiesBalanceAccountingReportV08) AddAlternateReportingCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
