...
type SecuritiesBalanceAccountingReportV05 struct {
	...
	BalanceForAccount []*model.AggregateBalanceInformation17 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification23 `xml:"SubAcctDtls,omitempty"`
...
func (s *SecuritiesBalanceAccountingReportV05) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceAccountingReportV05) AddStatementGeneralDetails() *model.Statement20 {
	s.StatementGeneralDetails = new(model.Statement20)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceAccountingReportV05) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceAccountingReportV05) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceAccountingReportV05) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceAccountingReportV05) AddIntermediaryInformation() *model.Intermediary21 {
...
func (s *SecuritiesBalanceAccountingReportV05) AddBalanceForAccount() *model.AggregateBalanceInformation17 {
	newValue := new(model.AggregateBalanceInformation17)
...
func (s *SecuritiesBalanceAccountingReportV05) AddSubAccountDetails() *model.SubAccountIdentification23 {
	newValue := new(model.SubAccountIdentification23)
...
func (s *SecuritiesBalanceAccountingReportV05) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
	s.AccountBaseCurrencyTotalAmounts = new(model.TotalValueInPageAndStatement2)
	return s.AccountBaseCurrencyTotalAmounts
}

func (s *SecuritiesBalanceAccountingReportV05) AddAlternateReportingCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
