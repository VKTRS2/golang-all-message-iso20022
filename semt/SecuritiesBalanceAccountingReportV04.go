...
type SecuritiesBalanceAccountingReportV04 struct {
	...
	BalanceForAccount []*model.AggregateBalanceInformation13 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification16 `xml:"SubAcctDtls,omitempty"`
...
func (s *SecuritiesBalanceAccountingReportV04) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceAccountingReportV04) AddStatementGeneralDetails() *model.Statement20 {
	s.StatementGeneralDetails = new(model.Statement20)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceAccountingReportV04) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceAccountingReportV04) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceAccountingReportV04) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceAccountingReportV04) AddIntermediaryInformation() *model.Intermediary21 {
...
func (s *SecuritiesBalanceAccountingReportV04) AddBalanceForAccount() *model.AggregateBalanceInformation13 {
	newValue := new(model.AggregateBalanceInformation13)
...
func (s *SecuritiesBalanceAccountingReportV04) AddSubAccountDetails() *model.SubAccountIdentification16 {
	newValue := new(model.SubAccountIdentification16)
...
func (s *SecuritiesBalanceAccountingReportV04) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
	s.AccountBaseCurrencyTotalAmounts = new(model.TotalValueInPageAndStatement2)
	return s.AccountBaseCurrencyTotalAmounts
}

func (s *SecuritiesBalanceAccountingReportV04) AddAlternateReportingCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
