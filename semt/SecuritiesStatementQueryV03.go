...
type SecuritiesStatementQueryV03 struct {
	...
	AdditionalQueryParameters []*model.AdditionalQueryParameters5 `xml:"AddtlQryParams,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesStatementQueryV03) AddStatementRequested() *model.DocumentNumber1 {
	s.StatementRequested = new(model.DocumentNumber1)
	return s.StatementRequested
}

func (s *SecuritiesStatementQueryV03) AddStatementGeneralDetails() *model.Statement16 {
	s.StatementGeneralDetails = new(model.Statement16)
	return s.StatementGeneralDetails
}

func (s *SecuritiesStatementQueryV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesStatementQueryV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesStatementQueryV03) AddAdditionalQueryParameters() *model.AdditionalQueryParameters5 {
	newValue := new(model.AdditionalQueryParameters5)
...
func (s *SecuritiesStatementQueryV03) AddSupplementaryData() *model.SupplementaryData1 {
