...
type SecuritiesMessageCancellationAdviceV04 struct {
	...
	Reference *model.References37Choice `xml:"Ref"`
...
func (s *SecuritiesMessageCancellationAdviceV04) AddReference() *model.References37Choice {
	s.Reference = new(model.References37Choice)
	return s.Reference
}

func (s *SecuritiesMessageCancellationAdviceV04) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesMessageCancellationAdviceV04) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesMessageCancellationAdviceV04) AddSupplementaryData() *model.SupplementaryData1 {
