...
type SecuritiesTransactionPendingReportV06 struct {
	...
	// Status information.
	Status []*model.StatusAndReason25 `xml:"Sts,omitempty"`

	// Details of the transactions reported.
	Transactions []*model.Transaction41 `xml:"Txs,omitempty"`
}

func (s *SecuritiesTransactionPendingReportV06) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesTransactionPendingReportV06) AddStatementGeneralDetails() *model.Statement14 {
	s.StatementGeneralDetails = new(model.Statement14)
	return s.StatementGeneralDetails
}

func (s *SecuritiesTransactionPendingReportV06) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionPendingReportV06) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionPendingReportV06) AddStatus() *model.StatusAndReason25 {
	newValue := new(model.StatusAndReason25)
...
func (s *SecuritiesTransactionPendingReportV06) AddTransactions() *model.Transaction41 {
	newValue := new(model.Transaction41)
