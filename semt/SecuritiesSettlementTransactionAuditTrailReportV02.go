...
type SecuritiesSettlementTransactionAuditTrailReportV02 struct {
	...
	StatusTrail []*model.StatusTrail4 `xml:"StsTrl,omitempty"`
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddQueryReference() *model.Identification1 {
	s.QueryReference = new(model.Identification1)
	return s.QueryReference
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddTransactionIdentification() *model.TransactionIdentifications15 {
	s.TransactionIdentification = new(model.TransactionIdentifications15)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionAuditTrailReportV02) AddStatusTrail() *model.StatusTrail4 {
	newValue := new(model.StatusTrail4)
