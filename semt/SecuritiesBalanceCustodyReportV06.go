...
type SecuritiesBalanceCustodyReportV06 struct {
	...
	BalanceForAccount []*model.AggregateBalanceInformation21 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification28 `xml:"SubAcctDtls,omitempty"`

	// Total valuation amounts provided in the base currency of the account.
	AccountBaseCurrencyTotalAmounts *model.TotalValueInPageAndStatement1 `xml:"AcctBaseCcyTtlAmts,omitempty"`
}

func (s *SecuritiesBalanceCustodyReportV06) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceCustodyReportV06) AddStatementGeneralDetails() *model.Statement33 {
	s.StatementGeneralDetails = new(model.Statement33)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceCustodyReportV06) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceCustodyReportV06) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceCustodyReportV06) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceCustodyReportV06) AddIntermediaryInformation() *model.Intermediary23 {
...
func (s *SecuritiesBalanceCustodyReportV06) AddBalanceForAccount() *model.AggregateBalanceInformation21 {
	newValue := new(model.AggregateBalanceInformation21)
...
func (s *SecuritiesBalanceCustodyReportV06) AddSubAccountDetails() *model.SubAccountIdentification28 {
	newValue := new(model.SubAccountIdentification28)
...
func (s *SecuritiesBalanceCustodyReportV06) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement1 {
