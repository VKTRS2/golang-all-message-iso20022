...
type SecuritiesBalanceCustodyReportV08 struct {
	...
	StatementGeneralDetails *model.Statement33 `xml:"StmtGnlDtls"`
	...
	BalanceForAccount []*model.AggregateBalanceInformation25 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification37 `xml:"SubAcctDtls,omitempty"`

	// Total valuation amounts provided in the base currency of the account.
	AccountBaseCurrencyTotalAmounts *model.TotalValueInPageAndStatement1 `xml:"AcctBaseCcyTtlAmts,omitempty"`
}

func (s *SecuritiesBalanceCustodyReportV08) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceCustodyReportV08) AddStatementGeneralDetails() *model.Statement33 {
	s.StatementGeneralDetails = new(model.Statement33)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceCustodyReportV08) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceCustodyReportV08) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceCustodyReportV08) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceCustodyReportV08) AddIntermediaryInformation() *model.Intermediary23 {
...
func (s *SecuritiesBalanceCustodyReportV08) AddBalanceForAccount() *model.AggregateBalanceInformation25 {
	newValue := new(model.AggregateBalanceInformation25)
...
func (s *SecuritiesBalanceCustodyReportV08) AddSubAccountDetails() *model.SubAccountIdentification37 {
	newValue := new(model.SubAccountIdentification37)
...
func (s *SecuritiesBalanceCustodyReportV08) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement1 {
