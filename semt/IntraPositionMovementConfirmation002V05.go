...
type IntraPositionMovementConfirmation002V05 struct {
	...
	IntraPositionDetails *model.IntraPositionDetails35 `xml:"IntraPosDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (i *IntraPositionMovementConfirmation002V05) AddAdditionalParameters() *model.AdditionalParameters25 {
	i.AdditionalParameters = new(model.AdditionalParameters25)
	return i.AdditionalParameters
}

func (i *IntraPositionMovementConfirmation002V05) AddAccountOwner() *model.PartyIdentification103Choice {
	i.AccountOwner = new(model.PartyIdentification103Choice)
	return i.AccountOwner
}

func (i *IntraPositionMovementConfirmation002V05) AddSafekeepingAccount() *model.SecuritiesAccount27 {
	i.SafekeepingAccount = new(model.SecuritiesAccount27)
	return i.SafekeepingAccount
}

func (i *IntraPositionMovementConfirmation002V05) AddSafekeepingPlace() *model.SafekeepingPlaceFormat17Choice {
	i.SafekeepingPlace = new(model.SafekeepingPlaceFormat17Choice)
	return i.SafekeepingPlace
}

func (i *IntraPositionMovementConfirmation002V05) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	i.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return i.FinancialInstrumentIdentification
}

func (i *IntraPositionMovementConfirmation002V05) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes75 {
	i.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes75)
	return i.FinancialInstrumentAttributes
}

func (i *IntraPositionMovementConfirmation002V05) AddIntraPositionDetails() *model.IntraPositionDetails35 {
	i.IntraPositionDetails = new(model.IntraPositionDetails35)
	return i.IntraPositionDetails
}

func (i *IntraPositionMovementConfirmation002V05) AddSupplementaryData() *model.SupplementaryData1 {
