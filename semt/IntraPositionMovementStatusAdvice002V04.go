...
type IntraPositionMovementStatusAdvice002V04 struct {
	...
	TransactionDetails *model.IntraPositionDetails38 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (i *IntraPositionMovementStatusAdvice002V04) AddTransactionIdentification() *model.TransactionIdentifications34 {
	i.TransactionIdentification = new(model.TransactionIdentifications34)
	return i.TransactionIdentification
}

func (i *IntraPositionMovementStatusAdvice002V04) AddProcessingStatus() *model.IntraPositionProcessingStatus6Choice {
	i.ProcessingStatus = new(model.IntraPositionProcessingStatus6Choice)
	return i.ProcessingStatus
}

func (i *IntraPositionMovementStatusAdvice002V04) AddSettlementStatus() *model.SettlementStatus20Choice {
	i.SettlementStatus = new(model.SettlementStatus20Choice)
	return i.SettlementStatus
}

func (i *IntraPositionMovementStatusAdvice002V04) AddTransactionDetails() *model.IntraPositionDetails38 {
	i.TransactionDetails = new(model.IntraPositionDetails38)
	return i.TransactionDetails
}

func (i *IntraPositionMovementStatusAdvice002V04) AddSupplementaryData() *model.SupplementaryData1 {
