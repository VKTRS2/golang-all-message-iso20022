...
type SecuritiesTransactionPostingReportV02 struct {
	...
	FinancialInstrumentDetails []*model.FinancialInstrumentDetails5 `xml:"FinInstrmDtls,omitempty"`

	// Details at sub-account level.
	SubAccountDetails []*model.SubAccountIdentification15 `xml:"SubAcctDtls,omitempty"`
}

func (s *SecuritiesTransactionPostingReportV02) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesTransactionPostingReportV02) AddStatementGeneralDetails() *model.Statement11 {
	s.StatementGeneralDetails = new(model.Statement11)
	return s.StatementGeneralDetails
}

func (s *SecuritiesTransactionPostingReportV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionPostingReportV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionPostingReportV02) AddFinancialInstrumentDetails() *model.FinancialInstrumentDetails5 {
	newValue := new(model.FinancialInstrumentDetails5)
...
func (s *SecuritiesTransactionPostingReportV02) AddSubAccountDetails() *model.SubAccountIdentification15 {
	newValue := new(model.SubAccountIdentification15)
