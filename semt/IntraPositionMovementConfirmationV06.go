...
type IntraPositionMovementConfirmationV06 struct {
	...
	IntraPositionDetails *model.IntraPositionDetails41 `xml:"IntraPosDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (i *IntraPositionMovementConfirmationV06) AddAdditionalParameters() *model.AdditionalParameters21 {
	i.AdditionalParameters = new(model.AdditionalParameters21)
	return i.AdditionalParameters
}

func (i *IntraPositionMovementConfirmationV06) AddAccountOwner() *model.PartyIdentification92Choice {
	i.AccountOwner = new(model.PartyIdentification92Choice)
	return i.AccountOwner
}

func (i *IntraPositionMovementConfirmationV06) AddSafekeepingAccount() *model.SecuritiesAccount24 {
	i.SafekeepingAccount = new(model.SecuritiesAccount24)
	return i.SafekeepingAccount
}

func (i *IntraPositionMovementConfirmationV06) AddSafekeepingPlace() *model.SafekeepingPlaceFormat10Choice {
	i.SafekeepingPlace = new(model.SafekeepingPlaceFormat10Choice)
	return i.SafekeepingPlace
}

func (i *IntraPositionMovementConfirmationV06) AddFinancialInstrumentIdentification() *model.SecurityIdentification19 {
	i.FinancialInstrumentIdentification = new(model.SecurityIdentification19)
	return i.FinancialInstrumentIdentification
}

func (i *IntraPositionMovementConfirmationV06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes63 {
	i.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes63)
	return i.FinancialInstrumentAttributes
}

func (i *IntraPositionMovementConfirmationV06) AddIntraPositionDetails() *model.IntraPositionDetails41 {
	i.IntraPositionDetails = new(model.IntraPositionDetails41)
	return i.IntraPositionDetails
}

func (i *IntraPositionMovementConfirmationV06) AddSupplementaryData() *model.SupplementaryData1 {
