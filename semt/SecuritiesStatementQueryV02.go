...
type SecuritiesStatementQueryV02 struct {
	...
	AdditionalQueryParameters []*model.AdditionalQueryParameters3 `xml:"AddtlQryParams,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesStatementQueryV02) AddStatementRequested() *model.DocumentNumber1 {
	s.StatementRequested = new(model.DocumentNumber1)
	return s.StatementRequested
}

func (s *SecuritiesStatementQueryV02) AddStatementGeneralDetails() *model.Statement16 {
	s.StatementGeneralDetails = new(model.Statement16)
	return s.StatementGeneralDetails
}

func (s *SecuritiesStatementQueryV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesStatementQueryV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesStatementQueryV02) AddAdditionalQueryParameters() *model.AdditionalQueryParameters3 {
	newValue := new(model.AdditionalQueryParameters3)
...
func (s *SecuritiesStatementQueryV02) AddSupplementaryData() *model.SupplementaryData1 {
