...
type SecuritiesTransactionPendingReportV04 struct {
	...
	// Status information.
	Status []*model.StatusAndReason16 `xml:"Sts,omitempty"`

	// Details of the transactions reported.
	Transactions []*model.Transaction27 `xml:"Txs,omitempty"`
}

func (s *SecuritiesTransactionPendingReportV04) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesTransactionPendingReportV04) AddStatementGeneralDetails() *model.Statement14 {
	s.StatementGeneralDetails = new(model.Statement14)
	return s.StatementGeneralDetails
}

func (s *SecuritiesTransactionPendingReportV04) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionPendingReportV04) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionPendingReportV04) AddStatus() *model.StatusAndReason16 {
	newValue := new(model.StatusAndReason16)
...
func (s *SecuritiesTransactionPendingReportV04) AddTransactions() *model.Transaction27 {
	newValue := new(model.Transaction27)
