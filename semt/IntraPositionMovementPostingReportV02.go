...
type IntraPositionMovementPostingReportV02 struct {
	...
	FinancialInstrument []*model.FinancialInstrumentDetails6 `xml:"FinInstrm,omitempty"`
}

func (i *IntraPositionMovementPostingReportV02) AddPagination() *model.Pagination {
	i.Pagination = new(model.Pagination)
	return i.Pagination
}

func (i *IntraPositionMovementPostingReportV02) AddStatementGeneralDetails() *model.Statement15 {
	i.StatementGeneralDetails = new(model.Statement15)
	return i.StatementGeneralDetails
}

func (i *IntraPositionMovementPostingReportV02) AddAccountOwner() *model.PartyIdentification36Choice {
	i.AccountOwner = new(model.PartyIdentification36Choice)
	return i.AccountOwner
}

func (i *IntraPositionMovementPostingReportV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	i.SafekeepingAccount = new(model.SecuritiesAccount13)
	return i.SafekeepingAccount
}

func (i *IntraPositionMovementPostingReportV02) AddFinancialInstrument() *model.FinancialInstrumentDetails6 {
	newValue := new(model.FinancialInstrumentDetails6)
