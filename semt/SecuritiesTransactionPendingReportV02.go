...
type SecuritiesTransactionPendingReportV02 struct {
	...
	// Status information.
	Status []*model.StatusAndReason7 `xml:"Sts,omitempty"`

	// Details of the transactions reported.
	Transactions []*model.Transaction12 `xml:"Txs,omitempty"`
}

func (s *SecuritiesTransactionPendingReportV02) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesTransactionPendingReportV02) AddStatementGeneralDetails() *model.Statement14 {
	s.StatementGeneralDetails = new(model.Statement14)
	return s.StatementGeneralDetails
}

func (s *SecuritiesTransactionPendingReportV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionPendingReportV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionPendingReportV02) AddStatus() *model.StatusAndReason7 {
	newValue := new(model.StatusAndReason7)
...
func (s *SecuritiesTransactionPendingReportV02) AddTransactions() *model.Transaction12 {
	newValue := new(model.Transaction12)
