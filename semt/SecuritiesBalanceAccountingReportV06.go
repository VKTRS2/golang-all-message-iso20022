...
func (s *SecuritiesBalanceAccountingReportV06) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceAccountingReportV06) AddStatementGeneralDetails() *model.Statement20 {
	s.StatementGeneralDetails = new(model.Statement20)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceAccountingReportV06) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceAccountingReportV06) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceAccountingReportV06) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceAccountingReportV06) AddIntermediaryInformation() *model.Intermediary23 {
...
func (s *SecuritiesBalanceAccountingReportV06) AddBalanceForAccount() *model.AggregateBalanceInformation22 {
...
func (s *SecuritiesBalanceAccountingReportV06) AddSubAccountDetails() *model.SubAccountIdentification29 {
...
func (s *SecuritiesBalanceAccountingReportV06) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
	s.AccountBaseCurrencyTotalAmounts = new(model.TotalValueInPageAndStatement2)
	return s.AccountBaseCurrencyTotalAmounts
}

func (s *SecuritiesBalanceAccountingReportV06) AddAlternateReportingCurrencyTotalAmounts() *model.TotalValueInPageAndStatement2 {
