...
type SecuritiesSettlementTransactionAllegementReportV03 struct {
	...
	AllegementDetails []*model.SecuritiesTradeDetails23 `xml:"AllgmtDtls,omitempty"`
}

func (s *SecuritiesSettlementTransactionAllegementReportV03) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesSettlementTransactionAllegementReportV03) AddStatementGeneralDetails() *model.Statement17 {
	s.StatementGeneralDetails = new(model.Statement17)
	return s.StatementGeneralDetails
}

func (s *SecuritiesSettlementTransactionAllegementReportV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionAllegementReportV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionAllegementReportV03) AddAllegementDetails() *model.SecuritiesTradeDetails23 {
	newValue := new(model.SecuritiesTradeDetails23)
