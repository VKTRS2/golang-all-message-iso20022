...
type IntraPositionMovementPostingReportV06 struct {
	...
	FinancialInstrument []*model.FinancialInstrumentDetails24 `xml:"FinInstrm,omitempty"`
}

func (i *IntraPositionMovementPostingReportV06) AddPagination() *model.Pagination {
	i.Pagination = new(model.Pagination)
	return i.Pagination
}

func (i *IntraPositionMovementPostingReportV06) AddStatementGeneralDetails() *model.Statement43 {
	i.StatementGeneralDetails = new(model.Statement43)
	return i.StatementGeneralDetails
}

func (i *IntraPositionMovementPostingReportV06) AddAccountOwner() *model.PartyIdentification92Choice {
	i.AccountOwner = new(model.PartyIdentification92Choice)
	return i.AccountOwner
}

func (i *IntraPositionMovementPostingReportV06) AddSafekeepingAccount() *model.SecuritiesAccount24 {
	i.SafekeepingAccount = new(model.SecuritiesAccount24)
	return i.SafekeepingAccount
}

func (i *IntraPositionMovementPostingReportV06) AddFinancialInstrument() *model.FinancialInstrumentDetails24 {
	newValue := new(model.FinancialInstrumentDetails24)
