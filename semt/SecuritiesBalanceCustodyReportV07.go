...
func (s *SecuritiesBalanceCustodyReportV07) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceCustodyReportV07) AddStatementGeneralDetails() *model.Statement33 {
	s.StatementGeneralDetails = new(model.Statement33)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceCustodyReportV07) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceCustodyReportV07) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceCustodyReportV07) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceCustodyReportV07) AddIntermediaryInformation() *model.Intermediary23 {
...
func (s *SecuritiesBalanceCustodyReportV07) AddBalanceForAccount() *model.AggregateBalanceInformation21 {
...
func (s *SecuritiesBalanceCustodyReportV07) AddSubAccountDetails() *model.SubAccountIdentification28 {
...
func (s *SecuritiesBalanceCustodyReportV07) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement1 {
