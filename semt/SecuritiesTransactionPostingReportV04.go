...
type SecuritiesTransactionPostingReportV04 struct {
	...
	FinancialInstrumentDetails []*model.FinancialInstrumentDetails13 `xml:"FinInstrmDtls,omitempty"`

	// Details at sub-account level.
	SubAccountDetails []*model.SubAccountIdentification30 `xml:"SubAcctDtls,omitempty"`
}

func (s *SecuritiesTransactionPostingReportV04) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesTransactionPostingReportV04) AddStatementGeneralDetails() *model.Statement11 {
	s.StatementGeneralDetails = new(model.Statement11)
	return s.StatementGeneralDetails
}

func (s *SecuritiesTransactionPostingReportV04) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionPostingReportV04) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionPostingReportV04) AddFinancialInstrumentDetails() *model.FinancialInstrumentDetails13 {
	newValue := new(model.FinancialInstrumentDetails13)
...
func (s *SecuritiesTransactionPostingReportV04) AddSubAccountDetails() *model.SubAccountIdentification30 {
	newValue := new(model.SubAccountIdentification30)
