...
type IntraPositionMovementPostingReport002V05 struct {
	...
	FinancialInstrument []*model.FinancialInstrumentDetails22 `xml:"FinInstrm,omitempty"`
}

func (i *IntraPositionMovementPostingReport002V05) AddPagination() *model.Pagination {
	i.Pagination = new(model.Pagination)
	return i.Pagination
}

func (i *IntraPositionMovementPostingReport002V05) AddStatementGeneralDetails() *model.Statement49 {
	i.StatementGeneralDetails = new(model.Statement49)
	return i.StatementGeneralDetails
}

func (i *IntraPositionMovementPostingReport002V05) AddAccountOwner() *model.PartyIdentification103Choice {
	i.AccountOwner = new(model.PartyIdentification103Choice)
	return i.AccountOwner
}

func (i *IntraPositionMovementPostingReport002V05) AddSafekeepingAccount() *model.SecuritiesAccount27 {
	i.SafekeepingAccount = new(model.SecuritiesAccount27)
	return i.SafekeepingAccount
}

func (i *IntraPositionMovementPostingReport002V05) AddFinancialInstrument() *model.FinancialInstrumentDetails22 {
	newValue := new(model.FinancialInstrumentDetails22)
