...
type SecuritiesSettlementTransactionAllegementReportV02 struct {
	...
	AllegementDetails []*model.SecuritiesTradeDetails17 `xml:"AllgmtDtls,omitempty"`
}

func (s *SecuritiesSettlementTransactionAllegementReportV02) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesSettlementTransactionAllegementReportV02) AddStatementGeneralDetails() *model.Statement17 {
	s.StatementGeneralDetails = new(model.Statement17)
	return s.StatementGeneralDetails
}

func (s *SecuritiesSettlementTransactionAllegementReportV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionAllegementReportV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionAllegementReportV02) AddAllegementDetails() *model.SecuritiesTradeDetails17 {
	newValue := new(model.SecuritiesTradeDetails17)
