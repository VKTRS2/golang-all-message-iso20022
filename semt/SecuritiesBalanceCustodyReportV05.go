...
type SecuritiesBalanceCustodyReportV05 struct {
	...
	BalanceForAccount []*model.AggregateBalanceInformation16 `xml:"BalForAcct,omitempty"`

	// Sub-account of the safekeeping or investment account.
	SubAccountDetails []*model.SubAccountIdentification22 `xml:"SubAcctDtls,omitempty"`

	// Total valuation amounts provided in the base currency of the account.
	AccountBaseCurrencyTotalAmounts *model.TotalValueInPageAndStatement1 `xml:"AcctBaseCcyTtlAmts,omitempty"`
}

func (s *SecuritiesBalanceCustodyReportV05) AddPagination() *model.Pagination {
	s.Pagination = new(model.Pagination)
	return s.Pagination
}

func (s *SecuritiesBalanceCustodyReportV05) AddStatementGeneralDetails() *model.Statement33 {
	s.StatementGeneralDetails = new(model.Statement33)
	return s.StatementGeneralDetails
}

func (s *SecuritiesBalanceCustodyReportV05) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesBalanceCustodyReportV05) AddAccountServicer() *model.PartyIdentification49Choice {
	s.AccountServicer = new(model.PartyIdentification49Choice)
	return s.AccountServicer
}

func (s *SecuritiesBalanceCustodyReportV05) AddSafekeepingAccount() *model.SecuritiesAccount11 {
	s.SafekeepingAccount = new(model.SecuritiesAccount11)
	return s.SafekeepingAccount
}

func (s *SecuritiesBalanceCustodyReportV05) AddIntermediaryInformation() *model.Intermediary21 {
...
func (s *SecuritiesBalanceCustodyReportV05) AddBalanceForAccount() *model.AggregateBalanceInformation16 {
	newValue := new(model.AggregateBalanceInformation16)
...
func (s *SecuritiesBalanceCustodyReportV05) AddSubAccountDetails() *model.SubAccountIdentification22 {
	newValue := new(model.SubAccountIdentification22)
...
func (s *SecuritiesBalanceCustodyReportV05) AddAccountBaseCurrencyTotalAmounts() *model.TotalValueInPageAndStatement1 {
