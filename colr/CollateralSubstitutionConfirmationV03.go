...
func (c *CollateralSubstitutionConfirmationV03) AddObligation() *model.Obligation3 {
	c.Obligation = new(model.Obligation3)
	return c.Obligation
}

func (c *CollateralSubstitutionConfirmationV03) AddAgreement() *model.Agreement2 {
	c.Agreement = new(model.Agreement2)
	return c.Agreement
}

func (c *CollateralSubstitutionConfirmationV03) AddSubstitutionConfirmation() *model.CollateralConfirmation1 {
	c.SubstitutionConfirmation = new(model.CollateralConfirmation1)
	return c.SubstitutionConfirmation
}

func (c *CollateralSubstitutionConfirmationV03) AddSupplementaryData() *model.SupplementaryData1 {
