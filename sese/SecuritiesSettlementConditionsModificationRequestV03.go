...
type SecuritiesSettlementConditionsModificationRequestV03 struct {
	...
	RequestDetails []*model.RequestDetails8 `xml:"ReqDtls"`
...
func (s *SecuritiesSettlementConditionsModificationRequestV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequestV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequestV03) AddRequestDetails() *model.RequestDetails8 {
	newValue := new(model.RequestDetails8)
...
func (s *SecuritiesSettlementConditionsModificationRequestV03) AddAdditionalInformation() *model.AdditionalInformation7 {
...
func (s *SecuritiesSettlementConditionsModificationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
