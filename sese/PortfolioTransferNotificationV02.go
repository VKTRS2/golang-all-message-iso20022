...
type PortfolioTransferNotificationV02 struct {
	...
	// Details of transfer.
	TransferNotificationDetails []*model.SecuritiesTradeDetails19 `xml:"TrfNtfctnDtls,omitempty"`
}

func (p *PortfolioTransferNotificationV02) AddPagination() *model.Pagination {
	p.Pagination = new(model.Pagination)
	return p.Pagination
}

func (p *PortfolioTransferNotificationV02) AddStatementGeneralDetails() *model.Statement19 {
	p.StatementGeneralDetails = new(model.Statement19)
	return p.StatementGeneralDetails
}

func (p *PortfolioTransferNotificationV02) AddAccountOwner() *model.PartyIdentification36Choice {
	p.AccountOwner = new(model.PartyIdentification36Choice)
	return p.AccountOwner
}

func (p *PortfolioTransferNotificationV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	p.SafekeepingAccount = new(model.SecuritiesAccount13)
	return p.SafekeepingAccount
}

func (p *PortfolioTransferNotificationV02) AddTransferNotificationDetails() *model.SecuritiesTradeDetails19 {
	newValue := new(model.SecuritiesTradeDetails19)
