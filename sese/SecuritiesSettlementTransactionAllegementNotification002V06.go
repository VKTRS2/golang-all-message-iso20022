...
type SecuritiesSettlementTransactionAllegementNotification002V06 struct {
	...
	QuantityAndAccountDetails *model.QuantityAndAccount58 `xml:"QtyAndAcctDtls"`
	...
	SettlementParameters *model.SettlementDetails131 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementTypeAndAdditionalParameters() *model.SettlementTypeAndAdditionalParameters15 {
...
func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddMarketInfrastructureTransactionIdentification() *model.Identification16 {
...
func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddTradeDetails() *model.SecuritiesTradeDetails60 {
	s.TradeDetails = new(model.SecuritiesTradeDetails60)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddQuantityAndAccountDetails() *model.QuantityAndAccount58 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount58)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSecuritiesFinancingDetails() *model.SecuritiesFinancingTransactionDetails34 {
	s.SecuritiesFinancingDetails = new(model.SecuritiesFinancingTransactionDetails34)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementParameters() *model.SettlementDetails131 {
	s.SettlementParameters = new(model.SettlementDetails131)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddCashParties() *model.CashParties32 {
	s.CashParties = new(model.CashParties32)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementAmount() *model.AmountAndDirection71 {
	s.SettlementAmount = new(model.AmountAndDirection71)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddOtherAmounts() *model.OtherAmounts36 {
	s.OtherAmounts = new(model.OtherAmounts36)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddOtherBusinessParties() *model.OtherParties31 {
	s.OtherBusinessParties = new(model.OtherParties31)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSupplementaryData() *model.SupplementaryData1 {
