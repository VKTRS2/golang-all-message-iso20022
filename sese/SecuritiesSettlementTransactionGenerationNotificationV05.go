...
type SecuritiesSettlementTransactionGenerationNotificationV05 struct {
	...
	TradeDetails *model.SecuritiesTradeDetails33 `xml:"TradDtls"`
	...
	SettlementParameters *model.SettlementDetails67 `xml:"SttlmParams"`
	...
	SettlementAmount *model.AmountAndDirection36 `xml:"SttlmAmt,omitempty"`
	...
	GeneratedReason []*model.GeneratedReason3 `xml:"GnrtdRsn,omitempty"`

	// Status and reason of the transaction.
	StatusAndReason *model.StatusAndReason19 `xml:"StsAndRsn,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification15 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification15)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddNumberCounts() *model.NumberCount1Choice {
	s.NumberCounts = new(model.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddLinkages() *model.Linkages17 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddTradeDetails() *model.SecuritiesTradeDetails33 {
	s.TradeDetails = new(model.SecuritiesTradeDetails33)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddFinancialInstrumentIdentification() *model.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddQuantityAndAccountDetails() *model.QuantityAndAccount25 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSettlementParameters() *model.SettlementDetails67 {
	s.SettlementParameters = new(model.SettlementDetails67)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddDeliveringSettlementParties() *model.SettlementParties11 {
	s.DeliveringSettlementParties = new(model.SettlementParties11)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddReceivingSettlementParties() *model.SettlementParties11 {
	s.ReceivingSettlementParties = new(model.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddCashParties() *model.CashParties17 {
	s.CashParties = new(model.CashParties17)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSettlementAmount() *model.AmountAndDirection36 {
	s.SettlementAmount = new(model.AmountAndDirection36)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddOtherAmounts() *model.OtherAmounts14 {
	s.OtherAmounts = new(model.OtherAmounts14)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddOtherBusinessParties() *model.OtherParties19 {
	s.OtherBusinessParties = new(model.OtherParties19)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters1 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddGeneratedReason() *model.GeneratedReason3 {
	newValue := new(model.GeneratedReason3)
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddStatusAndReason() *model.StatusAndReason19 {
	s.StatusAndReason = new(model.StatusAndReason19)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSupplementaryData() *model.SupplementaryData1 {
