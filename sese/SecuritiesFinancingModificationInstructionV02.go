...
func (s *SecuritiesFinancingModificationInstructionV02) AddTransactionTypeAndModificationAdditionalParameters() *model.TransactionTypeAndAdditionalParameters7 {
...
func (s *SecuritiesFinancingModificationInstructionV02) AddTradeDetails() *model.SecuritiesTradeDetails5 {
	s.TradeDetails = new(model.SecuritiesTradeDetails5)
	return s.TradeDetails
}

func (s *SecuritiesFinancingModificationInstructionV02) AddFinancialInstrumentIdentification() *model.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesFinancingModificationInstructionV02) AddQuantityAndAccountDetails() *model.QuantityAndAccount16 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount16)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV02) AddSecuritiesFinancingAdditionalDetails() *model.SecuritiesFinancingTransactionDetails1 {
...
func (s *SecuritiesFinancingModificationInstructionV02) AddSettlementParameters() *model.SettlementDetails3 {
	s.SettlementParameters = new(model.SettlementDetails3)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingModificationInstructionV02) AddDeliveringSettlementParties() *model.SettlementParties10 {
	s.DeliveringSettlementParties = new(model.SettlementParties10)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV02) AddReceivingSettlementParties() *model.SettlementParties10 {
	s.ReceivingSettlementParties = new(model.SettlementParties10)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV02) AddOpeningSettlementAmount() *model.AmountAndDirection10 {
	s.OpeningSettlementAmount = new(model.AmountAndDirection10)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstructionV02) AddSupplementaryData() *model.SupplementaryData1 {
