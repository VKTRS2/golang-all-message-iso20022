...
type SecuritiesSettlementTransactionModificationRequestV05 struct {
	...
	UpdateType []*model.UpdateType25Choice `xml:"UpdTp"`
}

func (s *SecuritiesSettlementTransactionModificationRequestV05) AddModifiedTransactionDetails() *model.TransactionDetails76 {
	s.ModifiedTransactionDetails = new(model.TransactionDetails76)
	return s.ModifiedTransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestV05) AddUpdateType() *model.UpdateType25Choice {
	newValue := new(model.UpdateType25Choice)
