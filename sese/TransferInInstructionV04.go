...
type TransferInInstructionV04 struct {
	...
	SettlementDetails *model.DeliverInformation9 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferInInstructionV04) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferInInstructionV04) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferInInstructionV04) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferInInstructionV04) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferInInstructionV04) AddTransferDetails() *model.Transfer21 {
...
func (t *TransferInInstructionV04) AddAccountDetails() *model.InvestmentAccount22 {
	t.AccountDetails = new(model.InvestmentAccount22)
	return t.AccountDetails
}

func (t *TransferInInstructionV04) AddSettlementDetails() *model.DeliverInformation9 {
	t.SettlementDetails = new(model.DeliverInformation9)
	return t.SettlementDetails
}

func (t *TransferInInstructionV04) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferInInstructionV04) AddExtension() *model.Extension1 {
