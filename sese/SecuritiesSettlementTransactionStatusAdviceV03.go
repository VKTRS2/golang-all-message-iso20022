...
type SecuritiesSettlementTransactionStatusAdviceV03 struct {
	...
	TransactionDetails *model.TransactionDetails36 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddTransactionIdentification() *model.TransactionIdentifications16 {
	s.TransactionIdentification = new(model.TransactionIdentifications16)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddProcessingStatus() *model.ProcessingStatus19Choice {
	s.ProcessingStatus = new(model.ProcessingStatus19Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddInferredMatchingStatus() *model.MatchingStatus7Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus7Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddMatchingStatus() *model.MatchingStatus7Choice {
	s.MatchingStatus = new(model.MatchingStatus7Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddSettlementStatus() *model.SettlementStatus7Choice {
	s.SettlementStatus = new(model.SettlementStatus7Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddTransactionDetails() *model.TransactionDetails36 {
	s.TransactionDetails = new(model.TransactionDetails36)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV03) AddSupplementaryData() *model.SupplementaryData1 {
