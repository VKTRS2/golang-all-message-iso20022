...
type ReversalOfTransferOutConfirmationV07 struct {
	...
	Reversal *model.Reversal8Choice `xml:"Rvsl"`
...
func (r *ReversalOfTransferOutConfirmationV07) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *ReversalOfTransferOutConfirmationV07) AddReferences() *model.References20 {
...
func (r *ReversalOfTransferOutConfirmationV07) AddReversal() *model.Reversal8Choice {
	r.Reversal = new(model.Reversal8Choice)
	return r.Reversal
}

func (r *ReversalOfTransferOutConfirmationV07) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	r.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return r.MarketPracticeVersion
}

func (r *ReversalOfTransferOutConfirmationV07) AddCopyDetails() *model.CopyInformation4 {
