...
type TransferInConfirmationV04 struct {
	...
	TransferDetails []*model.Transfer26 `xml:"TrfDtls"`
	...
	SettlementDetails *model.DeliverInformation11 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferInConfirmationV04) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferInConfirmationV04) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferInConfirmationV04) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferInConfirmationV04) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferInConfirmationV04) AddTransferDetails() *model.Transfer26 {
	newValue := new(model.Transfer26)
...
func (t *TransferInConfirmationV04) AddAccountDetails() *model.InvestmentAccount22 {
	t.AccountDetails = new(model.InvestmentAccount22)
	return t.AccountDetails
}

func (t *TransferInConfirmationV04) AddSettlementDetails() *model.DeliverInformation11 {
	t.SettlementDetails = new(model.DeliverInformation11)
	return t.SettlementDetails
}

func (t *TransferInConfirmationV04) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferInConfirmationV04) AddExtension() *model.Extension1 {
