...
type SecuritiesSettlementTransactionInstructionV06 struct {
	...
	SettlementTypeAndAdditionalParameters *model.SettlementTypeAndAdditionalParameters11 `xml:"SttlmTpAndAddtlParams"`
	...
	SettlementParameters *model.SettlementDetails93 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementTypeAndAdditionalParameters() *model.SettlementTypeAndAdditionalParameters11 {
	s.SettlementTypeAndAdditionalParameters = new(model.SettlementTypeAndAdditionalParameters11)
	return s.SettlementTypeAndAdditionalParameters
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddNumberCounts() *model.NumberCount1Choice {
	s.NumberCounts = new(model.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddLinkages() *model.Linkages37 {
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddTradeDetails() *model.SecuritiesTradeDetails51 {
	s.TradeDetails = new(model.SecuritiesTradeDetails51)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddFinancialInstrumentIdentification() *model.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddQuantityAndAccountDetails() *model.QuantityAndAccount39 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount39)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementParameters() *model.SettlementDetails93 {
	s.SettlementParameters = new(model.SettlementDetails93)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction11 {
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddDeliveringSettlementParties() *model.SettlementParties36 {
	s.DeliveringSettlementParties = new(model.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddReceivingSettlementParties() *model.SettlementParties36 {
	s.ReceivingSettlementParties = new(model.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddCashParties() *model.CashParties26 {
	s.CashParties = new(model.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementAmount() *model.AmountAndDirection46 {
	s.SettlementAmount = new(model.AmountAndDirection46)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddOtherAmounts() *model.OtherAmounts28 {
	s.OtherAmounts = new(model.OtherAmounts28)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddOtherBusinessParties() *model.OtherParties27 {
	s.OtherBusinessParties = new(model.OtherParties27)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters4 {
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddSupplementaryData() *model.SupplementaryData1 {
