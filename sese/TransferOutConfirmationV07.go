...
type TransferOutConfirmationV07 struct {
	...
	TransferDetails []*model.Transfer31 `xml:"TrfDtls"`

	// Information related to the account from which the financial instrument was withdrawn.
	AccountDetails *model.InvestmentAccount54 `xml:"AcctDtls"`

	// Information related to the receiving side of the transfer.
	SettlementDetails *model.ReceiveInformation17 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferOutConfirmationV07) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferOutConfirmationV07) AddPoolReference() *model.AdditionalReference6 {
	t.PoolReference = new(model.AdditionalReference6)
	return t.PoolReference
}

func (t *TransferOutConfirmationV07) AddPreviousReference() *model.AdditionalReference6 {
	t.PreviousReference = new(model.AdditionalReference6)
	return t.PreviousReference
}

func (t *TransferOutConfirmationV07) AddRelatedReference() *model.AdditionalReference6 {
...
func (t *TransferOutConfirmationV07) AddTransferDetails() *model.Transfer31 {
	newValue := new(model.Transfer31)
...
func (t *TransferOutConfirmationV07) AddAccountDetails() *model.InvestmentAccount54 {
	t.AccountDetails = new(model.InvestmentAccount54)
	return t.AccountDetails
}

func (t *TransferOutConfirmationV07) AddSettlementDetails() *model.ReceiveInformation17 {
	t.SettlementDetails = new(model.ReceiveInformation17)
	return t.SettlementDetails
}

func (t *TransferOutConfirmationV07) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	t.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return t.MarketPracticeVersion
}

func (t *TransferOutConfirmationV07) AddCopyDetails() *model.CopyInformation4 {
	t.CopyDetails = new(model.CopyInformation4)
	return t.CopyDetails
}

func (t *TransferOutConfirmationV07) AddExtension() *model.Extension1 {
