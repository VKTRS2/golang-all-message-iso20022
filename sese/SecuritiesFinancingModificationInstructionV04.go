...
func (s *SecuritiesFinancingModificationInstructionV04) AddTransactionTypeAndModificationAdditionalParameters() *model.TransactionTypeAndAdditionalParameters7 {
...
func (s *SecuritiesFinancingModificationInstructionV04) AddTradeDetails() *model.SecuritiesTradeDetails5 {
	s.TradeDetails = new(model.SecuritiesTradeDetails5)
	return s.TradeDetails
}

func (s *SecuritiesFinancingModificationInstructionV04) AddFinancialInstrumentIdentification() *model.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesFinancingModificationInstructionV04) AddQuantityAndAccountDetails() *model.QuantityAndAccount16 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount16)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV04) AddSecuritiesFinancingAdditionalDetails() *model.SecuritiesFinancingTransactionDetails19 {
...
func (s *SecuritiesFinancingModificationInstructionV04) AddSettlementParameters() *model.SettlementDetails72 {
	s.SettlementParameters = new(model.SettlementDetails72)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingModificationInstructionV04) AddDeliveringSettlementParties() *model.SettlementParties10 {
	s.DeliveringSettlementParties = new(model.SettlementParties10)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV04) AddReceivingSettlementParties() *model.SettlementParties10 {
	s.ReceivingSettlementParties = new(model.SettlementParties10)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV04) AddOpeningSettlementAmount() *model.AmountAndDirection10 {
	s.OpeningSettlementAmount = new(model.AmountAndDirection10)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstructionV04) AddSupplementaryData() *model.SupplementaryData1 {
