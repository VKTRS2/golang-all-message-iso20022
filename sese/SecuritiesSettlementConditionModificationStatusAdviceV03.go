...
type SecuritiesSettlementConditionModificationStatusAdviceV03 struct {
	...
	RequestDetails *model.RequestDetails8 `xml:"ReqDtls,omitempty"`
...
func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddRequestReference() *model.Identification1 {
	s.RequestReference = new(model.Identification1)
	return s.RequestReference
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddRequestDetails() *model.RequestDetails8 {
	s.RequestDetails = new(model.RequestDetails8)
	return s.RequestDetails
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddProcessingStatus() *model.ProcessingStatus18Choice {
	s.ProcessingStatus = new(model.ProcessingStatus18Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddSupplementaryData() *model.SupplementaryData1 {
