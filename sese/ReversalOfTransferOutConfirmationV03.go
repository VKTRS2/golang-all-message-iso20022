...
type ReversalOfTransferOutConfirmationV03 struct {
	...
	ReversalByTransferOutConfirmationDetails *model.TransferOut8 `xml:"RvslByTrfOutConfDtls,omitempty"`

	// Information provided when the message is a copy of a previous message.
	CopyDetails *model.CopyInformation2 `xml:"CpyDtls,omitempty"`
}

func (r *ReversalOfTransferOutConfirmationV03) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *ReversalOfTransferOutConfirmationV03) AddReferences() *model.References11 {
...
func (r *ReversalOfTransferOutConfirmationV03) AddReversalByReference() *model.TransferReference2 {
	r.ReversalByReference = new(model.TransferReference2)
	return r.ReversalByReference
}

func (r *ReversalOfTransferOutConfirmationV03) AddReversalByTransferOutConfirmationDetails() *model.TransferOut8 {
	r.ReversalByTransferOutConfirmationDetails = new(model.TransferOut8)
	return r.ReversalByTransferOutConfirmationDetails
}

func (r *ReversalOfTransferOutConfirmationV03) AddCopyDetails() *model.CopyInformation2 {
