...
type ReversalOfTransferInConfirmationV04 struct {
	...
	Reversal *model.Reversal2Choice `xml:"Rvsl"`

	// Information provided when the message is a copy of a previous message.
	CopyDetails *model.CopyInformation2 `xml:"CpyDtls,omitempty"`
}

func (r *ReversalOfTransferInConfirmationV04) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *ReversalOfTransferInConfirmationV04) AddReferences() *model.References11 {
...
func (r *ReversalOfTransferInConfirmationV04) AddReversal() *model.Reversal2Choice {
	r.Reversal = new(model.Reversal2Choice)
	return r.Reversal
}

func (r *ReversalOfTransferInConfirmationV04) AddCopyDetails() *model.CopyInformation2 {
