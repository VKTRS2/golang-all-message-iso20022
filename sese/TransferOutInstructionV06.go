...
type TransferOutInstructionV06 struct {
	...
	SettlementDetails *model.ReceiveInformation15 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferOutInstructionV06) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferOutInstructionV06) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferOutInstructionV06) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferOutInstructionV06) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferOutInstructionV06) AddRequestedTransferDate() *model.DateFormat1Choice {
	t.RequestedTransferDate = new(model.DateFormat1Choice)
	return t.RequestedTransferDate
}

func (t *TransferOutInstructionV06) AddTransferDetails() *model.Transfer27 {
...
func (t *TransferOutInstructionV06) AddAccountDetails() *model.InvestmentAccount40 {
	t.AccountDetails = new(model.InvestmentAccount40)
	return t.AccountDetails
}

func (t *TransferOutInstructionV06) AddSettlementDetails() *model.ReceiveInformation15 {
	t.SettlementDetails = new(model.ReceiveInformation15)
	return t.SettlementDetails
}

func (t *TransferOutInstructionV06) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	t.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return t.MarketPracticeVersion
}

func (t *TransferOutInstructionV06) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferOutInstructionV06) AddExtension() *model.Extension1 {
