...
type TransferInConfirmationV06 struct {
	...
	SettlementDetails *model.DeliverInformation14 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferInConfirmationV06) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferInConfirmationV06) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferInConfirmationV06) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferInConfirmationV06) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferInConfirmationV06) AddTransferDetails() *model.Transfer29 {
...
func (t *TransferInConfirmationV06) AddAccountDetails() *model.InvestmentAccount40 {
	t.AccountDetails = new(model.InvestmentAccount40)
	return t.AccountDetails
}

func (t *TransferInConfirmationV06) AddSettlementDetails() *model.DeliverInformation14 {
	t.SettlementDetails = new(model.DeliverInformation14)
	return t.SettlementDetails
}

func (t *TransferInConfirmationV06) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	t.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return t.MarketPracticeVersion
}

func (t *TransferInConfirmationV06) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferInConfirmationV06) AddExtension() *model.Extension1 {
