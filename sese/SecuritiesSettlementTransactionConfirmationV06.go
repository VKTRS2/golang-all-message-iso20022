...
type SecuritiesSettlementTransactionConfirmationV06 struct {
	...
	AdditionalParameters *model.AdditionalParameters22 `xml:"AddtlParams,omitempty"`
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification19 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification19)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddLinkages() *model.Linkages41 {
	s.Linkages = new(model.Linkages41)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddAdditionalParameters() *model.AdditionalParameters22 {
	s.AdditionalParameters = new(model.AdditionalParameters22)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddTradeDetails() *model.SecuritiesTradeDetails53 {
	s.TradeDetails = new(model.SecuritiesTradeDetails53)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddFinancialInstrumentIdentification() *model.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddQuantityAndAccountDetails() *model.QuantityAndAccount41 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount41)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddSettlementParameters() *model.SettlementDetails90 {
	s.SettlementParameters = new(model.SettlementDetails90)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction11 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddDeliveringSettlementParties() *model.SettlementParties36 {
	s.DeliveringSettlementParties = new(model.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddReceivingSettlementParties() *model.SettlementParties36 {
	s.ReceivingSettlementParties = new(model.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddCashParties() *model.CashParties26 {
	s.CashParties = new(model.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddSettledAmount() *model.AmountAndDirection46 {
	s.SettledAmount = new(model.AmountAndDirection46)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddOtherAmounts() *model.OtherAmounts30 {
	s.OtherAmounts = new(model.OtherAmounts30)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddOtherBusinessParties() *model.OtherParties27 {
	s.OtherBusinessParties = new(model.OtherParties27)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters4 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddSupplementaryData() *model.SupplementaryData1 {
