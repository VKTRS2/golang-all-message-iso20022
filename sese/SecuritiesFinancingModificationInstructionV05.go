...
type SecuritiesFinancingModificationInstructionV05 struct {
	...
	TransactionTypeAndModificationAdditionalParameters *model.TransactionTypeAndAdditionalParameters11 `xml:"TxTpAndModAddtlParams"`
...
func (s *SecuritiesFinancingModificationInstructionV05) AddTransactionTypeAndModificationAdditionalParameters() *model.TransactionTypeAndAdditionalParameters11 {
	s.TransactionTypeAndModificationAdditionalParameters = new(model.TransactionTypeAndAdditionalParameters11)
	return s.TransactionTypeAndModificationAdditionalParameters
}

func (s *SecuritiesFinancingModificationInstructionV05) AddTradeDetails() *model.SecuritiesTradeDetails5 {
	s.TradeDetails = new(model.SecuritiesTradeDetails5)
	return s.TradeDetails
}

func (s *SecuritiesFinancingModificationInstructionV05) AddFinancialInstrumentIdentification() *model.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesFinancingModificationInstructionV05) AddQuantityAndAccountDetails() *model.QuantityAndAccount38 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount38)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV05) AddSecuritiesFinancingAdditionalDetails() *model.SecuritiesFinancingTransactionDetails27 {
...
func (s *SecuritiesFinancingModificationInstructionV05) AddSettlementParameters() *model.SettlementDetails97 {
	s.SettlementParameters = new(model.SettlementDetails97)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingModificationInstructionV05) AddDeliveringSettlementParties() *model.SettlementParties36 {
	s.DeliveringSettlementParties = new(model.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV05) AddReceivingSettlementParties() *model.SettlementParties36 {
	s.ReceivingSettlementParties = new(model.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV05) AddOpeningSettlementAmount() *model.AmountAndDirection49 {
	s.OpeningSettlementAmount = new(model.AmountAndDirection49)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstructionV05) AddSupplementaryData() *model.SupplementaryData1 {
