...
type SecuritiesSettlementTransactionConfirmation002V07 struct {
	...
	AdditionalParameters *model.AdditionalParameters31 `xml:"AddtlParams,omitempty"`
...
func (s *SecuritiesSettlementTransactionConfirmation002V07) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification24 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification24)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddLinkages() *model.Linkages50 {
	s.Linkages = new(model.Linkages50)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddAdditionalParameters() *model.AdditionalParameters31 {
	s.AdditionalParameters = new(model.AdditionalParameters31)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddTradeDetails() *model.SecuritiesTradeDetails62 {
	s.TradeDetails = new(model.SecuritiesTradeDetails62)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddQuantityAndAccountDetails() *model.QuantityAndAccount57 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount57)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddSettlementParameters() *model.SettlementDetails134 {
	s.SettlementParameters = new(model.SettlementDetails134)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V07) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddCashParties() *model.CashParties30 {
	s.CashParties = new(model.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddSettledAmount() *model.AmountAndDirection60 {
	s.SettledAmount = new(model.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddOtherAmounts() *model.OtherAmounts38 {
	s.OtherAmounts = new(model.OtherAmounts38)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddOtherBusinessParties() *model.OtherParties29 {
	s.OtherBusinessParties = new(model.OtherParties29)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V07) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters5 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V07) AddSupplementaryData() *model.SupplementaryData1 {
