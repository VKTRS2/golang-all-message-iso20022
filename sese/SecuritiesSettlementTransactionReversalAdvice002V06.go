...
type SecuritiesSettlementTransactionReversalAdvice002V06 struct {
	...
	AdditionalParameters *model.AdditionalParameters32 `xml:"AddtlParams,omitempty"`
	...
	QuantityAndAccountDetails *model.QuantityAndAccount57 `xml:"QtyAndAcctDtls"`

	// Parameters which explicitly state the conditions that must be fulfilled before a particular  transaction of a financial instrument can be settled.  These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.
	SettlementParameters *model.SettlementDetails134 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification24 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification24)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddConfirmationReference() *model.Identification16 {
	s.ConfirmationReference = new(model.Identification16)
	return s.ConfirmationReference
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddAdditionalParameters() *model.AdditionalParameters32 {
	s.AdditionalParameters = new(model.AdditionalParameters32)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddTradeDetails() *model.SecuritiesTradeDetails62 {
	s.TradeDetails = new(model.SecuritiesTradeDetails62)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddQuantityAndAccountDetails() *model.QuantityAndAccount57 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount57)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSettlementParameters() *model.SettlementDetails134 {
	s.SettlementParameters = new(model.SettlementDetails134)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddCashParties() *model.CashParties32 {
	s.CashParties = new(model.CashParties32)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSettledAmount() *model.AmountAndDirection60 {
	s.SettledAmount = new(model.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddOtherAmounts() *model.OtherAmounts38 {
	s.OtherAmounts = new(model.OtherAmounts38)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddOtherBusinessParties() *model.OtherParties29 {
	s.OtherBusinessParties = new(model.OtherParties29)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters5 {
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSupplementaryData() *model.SupplementaryData1 {
