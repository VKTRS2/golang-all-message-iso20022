...
type TransferOutConfirmationV03 struct {
	...
	TransferDetails []*model.Transfer13 `xml:"TrfDtls"`

	// Information related to the account from which the financial instrument was withdrawn.
	AccountDetails *model.InvestmentAccount22 `xml:"AcctDtls"`

	// Information related to the receiving side of the transfer.
	SettlementDetails *model.ReceiveInformation6 `xml:"SttlmDtls"`
...
func (t *TransferOutConfirmationV03) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferOutConfirmationV03) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferOutConfirmationV03) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferOutConfirmationV03) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferOutConfirmationV03) AddTransferDetails() *model.Transfer13 {
	newValue := new(model.Transfer13)
...
func (t *TransferOutConfirmationV03) AddAccountDetails() *model.InvestmentAccount22 {
	t.AccountDetails = new(model.InvestmentAccount22)
	return t.AccountDetails
}

func (t *TransferOutConfirmationV03) AddSettlementDetails() *model.ReceiveInformation6 {
	t.SettlementDetails = new(model.ReceiveInformation6)
	return t.SettlementDetails
}

func (t *TransferOutConfirmationV03) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferOutConfirmationV03) AddExtension() *model.Extension1 {
