...
func (s *SecuritiesTransactionCancellationRequestV04) AddAccountOwnerTransactionIdentification() *model.References2Choice {
...
func (s *SecuritiesTransactionCancellationRequestV04) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionCancellationRequestV04) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionCancellationRequestV04) AddTransactionDetails() *model.TransactionDetails28 {
	s.TransactionDetails = new(model.TransactionDetails28)
	return s.TransactionDetails
}

func (s *SecuritiesTransactionCancellationRequestV04) AddFXCancellation() *model.FXCancellation1Choice {
	s.FXCancellation = new(model.FXCancellation1Choice)
	return s.FXCancellation
}

func (s *SecuritiesTransactionCancellationRequestV04) AddSupplementaryData() *model.SupplementaryData1 {
