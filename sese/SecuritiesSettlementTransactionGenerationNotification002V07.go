...
type SecuritiesSettlementTransactionGenerationNotification002V07 struct {
	...
	TradeDetails *model.SecuritiesTradeDetails70 `xml:"TradDtls"`
	...
	QuantityAndAccountDetails []*model.QuantityAndAccount56 `xml:"QtyAndAcctDtls"`

	// Parameters which explicitly state the conditions that must be fulfilled before a particular  transaction of a financial instrument can be settled.  These parameters are defined by the instructing party in compliance with settlement rules in the market the transaction will settle in.
	SettlementParameters *model.SettlementDetails137 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification24 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification24)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddNumberCounts() *model.NumberCount1Choice {
	s.NumberCounts = new(model.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddLinkages() *model.Linkages43 {
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddTradeDetails() *model.SecuritiesTradeDetails70 {
	s.TradeDetails = new(model.SecuritiesTradeDetails70)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddQuantityAndAccountDetails() *model.QuantityAndAccount56 {
	newValue := new(model.QuantityAndAccount56)
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddSettlementParameters() *model.SettlementDetails137 {
	s.SettlementParameters = new(model.SettlementDetails137)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddCashParties() *model.CashParties30 {
	s.CashParties = new(model.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddSettlementAmount() *model.AmountAndDirection60 {
	s.SettlementAmount = new(model.AmountAndDirection60)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddOtherAmounts() *model.OtherAmounts35 {
	s.OtherAmounts = new(model.OtherAmounts35)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddOtherBusinessParties() *model.OtherParties29 {
	s.OtherBusinessParties = new(model.OtherParties29)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters5 {
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddGeneratedReason() *model.GeneratedReason6 {
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddStatusAndReason() *model.StatusAndReason29 {
	s.StatusAndReason = new(model.StatusAndReason29)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V07) AddSupplementaryData() *model.SupplementaryData1 {
