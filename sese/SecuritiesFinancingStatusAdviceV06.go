...
type SecuritiesFinancingStatusAdviceV06 struct {
	...
	TransactionDetails *model.SecuritiesFinancingTransactionDetails26 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesFinancingStatusAdviceV06) AddTransactionIdentification() *model.TransactionIdentifications32 {
	s.TransactionIdentification = new(model.TransactionIdentifications32)
	return s.TransactionIdentification
}

func (s *SecuritiesFinancingStatusAdviceV06) AddProcessingStatus() *model.ProcessingStatus51Choice {
	s.ProcessingStatus = new(model.ProcessingStatus51Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddMatchingStatus() *model.MatchingStatus26Choice {
	s.MatchingStatus = new(model.MatchingStatus26Choice)
	return s.MatchingStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddInferredMatchingStatus() *model.MatchingStatus26Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus26Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddSettlementStatus() *model.SettlementStatus18Choice {
	s.SettlementStatus = new(model.SettlementStatus18Choice)
	return s.SettlementStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddRepoCallRequestStatus() *model.RepoCallRequestStatus7Choice {
	s.RepoCallRequestStatus = new(model.RepoCallRequestStatus7Choice)
	return s.RepoCallRequestStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddTransactionDetails() *model.SecuritiesFinancingTransactionDetails26 {
	s.TransactionDetails = new(model.SecuritiesFinancingTransactionDetails26)
	return s.TransactionDetails
}

func (s *SecuritiesFinancingStatusAdviceV06) AddSupplementaryData() *model.SupplementaryData1 {
