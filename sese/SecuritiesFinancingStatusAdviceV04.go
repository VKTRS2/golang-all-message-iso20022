...
type SecuritiesFinancingStatusAdviceV04 struct {
	...
	TransactionDetails *model.SecuritiesFinancingTransactionDetails21 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesFinancingStatusAdviceV04) AddTransactionIdentification() *model.TransactionIdentifications1 {
	s.TransactionIdentification = new(model.TransactionIdentifications1)
	return s.TransactionIdentification
}

func (s *SecuritiesFinancingStatusAdviceV04) AddProcessingStatus() *model.ProcessingStatus38Choice {
	s.ProcessingStatus = new(model.ProcessingStatus38Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesFinancingStatusAdviceV04) AddMatchingStatus() *model.MatchingStatus20Choice {
	s.MatchingStatus = new(model.MatchingStatus20Choice)
	return s.MatchingStatus
}

func (s *SecuritiesFinancingStatusAdviceV04) AddInferredMatchingStatus() *model.MatchingStatus20Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus20Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesFinancingStatusAdviceV04) AddSettlementStatus() *model.SettlementStatus10Choice {
	s.SettlementStatus = new(model.SettlementStatus10Choice)
	return s.SettlementStatus
}

func (s *SecuritiesFinancingStatusAdviceV04) AddRepoCallRequestStatus() *model.RepoCallRequestStatus5Choice {
	s.RepoCallRequestStatus = new(model.RepoCallRequestStatus5Choice)
	return s.RepoCallRequestStatus
}

func (s *SecuritiesFinancingStatusAdviceV04) AddTransactionDetails() *model.SecuritiesFinancingTransactionDetails21 {
	s.TransactionDetails = new(model.SecuritiesFinancingTransactionDetails21)
	return s.TransactionDetails
}

func (s *SecuritiesFinancingStatusAdviceV04) AddSupplementaryData() *model.SupplementaryData1 {
