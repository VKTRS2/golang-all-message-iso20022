...
type SecuritiesSettlementConditionsModificationRequestV02 struct {
	...
	RequestDetails []*model.RequestDetails6 `xml:"ReqDtls"`
...
func (s *SecuritiesSettlementConditionsModificationRequestV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequestV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequestV02) AddRequestDetails() *model.RequestDetails6 {
	newValue := new(model.RequestDetails6)
...
func (s *SecuritiesSettlementConditionsModificationRequestV02) AddAdditionalInformation() *model.AdditionalInformation7 {
...
func (s *SecuritiesSettlementConditionsModificationRequestV02) AddSupplementaryData() *model.SupplementaryData1 {
