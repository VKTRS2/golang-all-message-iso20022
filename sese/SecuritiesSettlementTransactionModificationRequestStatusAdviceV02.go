...
func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddModificationRequestReference() *model.Identification1 {
	s.ModificationRequestReference = new(model.Identification1)
	return s.ModificationRequestReference
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddTransactionIdentification() *model.TransactionIdentifications25 {
	s.TransactionIdentification = new(model.TransactionIdentifications25)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddModificationProcessingStatus() *model.ModificationProcessingStatus2Choice {
	s.ModificationProcessingStatus = new(model.ModificationProcessingStatus2Choice)
	return s.ModificationProcessingStatus
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddTransactionDetails() *model.TransactionDetails45 {
	s.TransactionDetails = new(model.TransactionDetails45)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddSupplementaryData() *model.SupplementaryData1 {
