...
type ReversalOfTransferOutConfirmationV05 struct {
	...
	Reversal *model.Reversal3Choice `xml:"Rvsl"`
...
func (r *ReversalOfTransferOutConfirmationV05) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *ReversalOfTransferOutConfirmationV05) AddReferences() *model.References15 {
...
func (r *ReversalOfTransferOutConfirmationV05) AddReversal() *model.Reversal3Choice {
	r.Reversal = new(model.Reversal3Choice)
	return r.Reversal
}

func (r *ReversalOfTransferOutConfirmationV05) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	r.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return r.MarketPracticeVersion
}

func (r *ReversalOfTransferOutConfirmationV05) AddCopyDetails() *model.CopyInformation2 {
