...
type SecuritiesSettlementTransactionModificationRequestStatusAdviceV01 struct {
	...
	TransactionIdentification *model.TransactionIdentifications18 `xml:"TxId,omitempty"`

	// Provides details on the processing status of the request.
	ModificationProcessingStatus *model.ModificationProcessingStatus2Choice `xml:"ModPrcgSts"`
...
func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddModificationRequestReference() *model.Identification1 {
	s.ModificationRequestReference = new(model.Identification1)
	return s.ModificationRequestReference
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddTransactionIdentification() *model.TransactionIdentifications18 {
	s.TransactionIdentification = new(model.TransactionIdentifications18)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddModificationProcessingStatus() *model.ModificationProcessingStatus2Choice {
	s.ModificationProcessingStatus = new(model.ModificationProcessingStatus2Choice)
	return s.ModificationProcessingStatus
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddTransactionDetails() *model.TransactionDetails45 {
	s.TransactionDetails = new(model.TransactionDetails45)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddSupplementaryData() *model.SupplementaryData1 {
