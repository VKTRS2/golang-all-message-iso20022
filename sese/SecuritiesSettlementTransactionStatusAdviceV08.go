...
type SecuritiesSettlementTransactionStatusAdviceV08 struct {
	...
	TransactionDetails *model.TransactionDetails97 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddTransactionIdentification() *model.TransactionIdentifications31 {
	s.TransactionIdentification = new(model.TransactionIdentifications31)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddLinkages() *model.Linkages41 {
	s.Linkages = new(model.Linkages41)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddProcessingStatus() *model.ProcessingStatus48Choice {
	s.ProcessingStatus = new(model.ProcessingStatus48Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddInferredMatchingStatus() *model.MatchingStatus24Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus24Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddMatchingStatus() *model.MatchingStatus24Choice {
	s.MatchingStatus = new(model.MatchingStatus24Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddSettlementStatus() *model.SettlementStatus17Choice {
	s.SettlementStatus = new(model.SettlementStatus17Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddTransactionDetails() *model.TransactionDetails97 {
	s.TransactionDetails = new(model.TransactionDetails97)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddSupplementaryData() *model.SupplementaryData1 {
