...
type SecuritiesSettlementConditionsModificationRequestV06 struct {
	...
	AdditionalInformation []*model.AdditionalInformation11 `xml:"AddtlInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementConditionsModificationRequestV06) AddAccountOwner() *model.PartyIdentification98 {
	s.AccountOwner = new(model.PartyIdentification98)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequestV06) AddSafekeepingAccount() *model.SecuritiesAccount19 {
	s.SafekeepingAccount = new(model.SecuritiesAccount19)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequestV06) AddRequestDetails() *model.RequestDetails15 {
...
func (s *SecuritiesSettlementConditionsModificationRequestV06) AddAdditionalInformation() *model.AdditionalInformation11 {
	newValue := new(model.AdditionalInformation11)
...
func (s *SecuritiesSettlementConditionsModificationRequestV06) AddSupplementaryData() *model.SupplementaryData1 {
