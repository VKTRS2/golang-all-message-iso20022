...
type SecuritiesSettlementTransactionStatusAdviceV06 struct {
	...
	ProcessingStatus *model.ProcessingStatus37Choice `xml:"PrcgSts,omitempty"`

	// Provides the matching status of an instruction as per the account servicer based on an allegement. At this time no matching took place on the market (at the CSD/ICSD).
	InferredMatchingStatus *model.MatchingStatus19Choice `xml:"IfrrdMtchgSts,omitempty"`

	// Provides the matching status of the instruction.
	MatchingStatus *model.MatchingStatus19Choice `xml:"MtchgSts,omitempty"`

	// Provides the status of settlement of a transaction.
	SettlementStatus *model.SettlementStatus7Choice `xml:"SttlmSts,omitempty"`

	// Identifies the details of the transaction.
	TransactionDetails *model.TransactionDetails70 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddTransactionIdentification() *model.TransactionIdentifications16 {
	s.TransactionIdentification = new(model.TransactionIdentifications16)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddProcessingStatus() *model.ProcessingStatus37Choice {
	s.ProcessingStatus = new(model.ProcessingStatus37Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddInferredMatchingStatus() *model.MatchingStatus19Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus19Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddMatchingStatus() *model.MatchingStatus19Choice {
	s.MatchingStatus = new(model.MatchingStatus19Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddSettlementStatus() *model.SettlementStatus7Choice {
	s.SettlementStatus = new(model.SettlementStatus7Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddTransactionDetails() *model.TransactionDetails70 {
	s.TransactionDetails = new(model.TransactionDetails70)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV06) AddSupplementaryData() *model.SupplementaryData1 {
