...
type SecuritiesFinancingStatusAdvice002V07 struct {
	...
	TransactionDetails *model.SecuritiesFinancingTransactionDetails36 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddTransactionIdentification() *model.TransactionIdentifications35 {
	s.TransactionIdentification = new(model.TransactionIdentifications35)
	return s.TransactionIdentification
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddProcessingStatus() *model.ProcessingStatus57Choice {
	s.ProcessingStatus = new(model.ProcessingStatus57Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddMatchingStatus() *model.MatchingStatus29Choice {
	s.MatchingStatus = new(model.MatchingStatus29Choice)
	return s.MatchingStatus
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddInferredMatchingStatus() *model.MatchingStatus29Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus29Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddSettlementStatus() *model.SettlementStatus21Choice {
	s.SettlementStatus = new(model.SettlementStatus21Choice)
	return s.SettlementStatus
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddRepoCallRequestStatus() *model.RepoCallRequestStatus9Choice {
	s.RepoCallRequestStatus = new(model.RepoCallRequestStatus9Choice)
	return s.RepoCallRequestStatus
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddTransactionDetails() *model.SecuritiesFinancingTransactionDetails36 {
	s.TransactionDetails = new(model.SecuritiesFinancingTransactionDetails36)
	return s.TransactionDetails
}

func (s *SecuritiesFinancingStatusAdvice002V07) AddSupplementaryData() *model.SupplementaryData1 {
