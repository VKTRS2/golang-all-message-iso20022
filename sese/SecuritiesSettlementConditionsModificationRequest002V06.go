...
type SecuritiesSettlementConditionsModificationRequest002V06 struct {
	...
	AdditionalInformation []*model.AdditionalInformation12 `xml:"AddtlInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementConditionsModificationRequest002V06) AddAccountOwner() *model.PartyIdentification109 {
	s.AccountOwner = new(model.PartyIdentification109)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequest002V06) AddSafekeepingAccount() *model.SecuritiesAccount30 {
	s.SafekeepingAccount = new(model.SecuritiesAccount30)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequest002V06) AddRequestDetails() *model.RequestDetails16 {
...
func (s *SecuritiesSettlementConditionsModificationRequest002V06) AddAdditionalInformation() *model.AdditionalInformation12 {
	newValue := new(model.AdditionalInformation12)
...
func (s *SecuritiesSettlementConditionsModificationRequest002V06) AddSupplementaryData() *model.SupplementaryData1 {
