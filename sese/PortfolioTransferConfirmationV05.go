...
type PortfolioTransferConfirmationV05 struct {
	...
	ProductTransfer []*model.ISATransfer13 `xml:"PdctTrf"`
...
func (p *PortfolioTransferConfirmationV05) AddMessageReference() *model.MessageIdentification1 {
	p.MessageReference = new(model.MessageIdentification1)
	return p.MessageReference
}

func (p *PortfolioTransferConfirmationV05) AddPoolReference() *model.AdditionalReference3 {
	p.PoolReference = new(model.AdditionalReference3)
	return p.PoolReference
}

func (p *PortfolioTransferConfirmationV05) AddPreviousReference() *model.AdditionalReference3 {
	p.PreviousReference = new(model.AdditionalReference3)
	return p.PreviousReference
}

func (p *PortfolioTransferConfirmationV05) AddRelatedReference() *model.AdditionalReference3 {
	p.RelatedReference = new(model.AdditionalReference3)
	return p.RelatedReference
}

func (p *PortfolioTransferConfirmationV05) AddPrimaryIndividualInvestor() *model.IndividualPerson8 {
	p.PrimaryIndividualInvestor = new(model.IndividualPerson8)
	return p.PrimaryIndividualInvestor
}

func (p *PortfolioTransferConfirmationV05) AddSecondaryIndividualInvestor() *model.IndividualPerson8 {
	p.SecondaryIndividualInvestor = new(model.IndividualPerson8)
	return p.SecondaryIndividualInvestor
}

func (p *PortfolioTransferConfirmationV05) AddOtherIndividualInvestor() *model.IndividualPerson8 {
...
func (p *PortfolioTransferConfirmationV05) AddPrimaryCorporateInvestor() *model.Organisation4 {
	p.PrimaryCorporateInvestor = new(model.Organisation4)
	return p.PrimaryCorporateInvestor
}

func (p *PortfolioTransferConfirmationV05) AddSecondaryCorporateInvestor() *model.Organisation4 {
	p.SecondaryCorporateInvestor = new(model.Organisation4)
	return p.SecondaryCorporateInvestor
}

func (p *PortfolioTransferConfirmationV05) AddOtherCorporateInvestor() *model.Organisation4 {
...
func (p *PortfolioTransferConfirmationV05) AddTransferorAccount() *model.Account15 {
	p.TransferorAccount = new(model.Account15)
	return p.TransferorAccount
}

func (p *PortfolioTransferConfirmationV05) AddNomineeAccount() *model.Account16 {
	p.NomineeAccount = new(model.Account16)
	return p.NomineeAccount
}

func (p *PortfolioTransferConfirmationV05) AddTransferee() *model.PartyIdentification2Choice {
	p.Transferee = new(model.PartyIdentification2Choice)
	return p.Transferee
}

func (p *PortfolioTransferConfirmationV05) AddCashAccount() *model.CashAccount29 {
	p.CashAccount = new(model.CashAccount29)
	return p.CashAccount
}

func (p *PortfolioTransferConfirmationV05) AddProductTransfer() *model.ISATransfer13 {
	newValue := new(model.ISATransfer13)
...
func (p *PortfolioTransferConfirmationV05) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	p.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return p.MarketPracticeVersion
}

func (p *PortfolioTransferConfirmationV05) AddExtension() *model.Extension1 {
