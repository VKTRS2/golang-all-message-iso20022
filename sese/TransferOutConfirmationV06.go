...
type TransferOutConfirmationV06 struct {
	...
	SettlementDetails *model.ReceiveInformation14 `xml:"SttlmDtls,omitempty"`
...
func (t *TransferOutConfirmationV06) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferOutConfirmationV06) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferOutConfirmationV06) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferOutConfirmationV06) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferOutConfirmationV06) AddTransferDetails() *model.Transfer28 {
...
func (t *TransferOutConfirmationV06) AddAccountDetails() *model.InvestmentAccount40 {
	t.AccountDetails = new(model.InvestmentAccount40)
	return t.AccountDetails
}

func (t *TransferOutConfirmationV06) AddSettlementDetails() *model.ReceiveInformation14 {
	t.SettlementDetails = new(model.ReceiveInformation14)
	return t.SettlementDetails
}

func (t *TransferOutConfirmationV06) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	t.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return t.MarketPracticeVersion
}

func (t *TransferOutConfirmationV06) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferOutConfirmationV06) AddExtension() *model.Extension1 {
