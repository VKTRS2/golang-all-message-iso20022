...
type SecuritiesSettlementTransactionStatusAdviceV05 struct {
	...
	TransactionDetails *model.TransactionDetails61 `xml:"TxDtls,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddTransactionIdentification() *model.TransactionIdentifications16 {
	s.TransactionIdentification = new(model.TransactionIdentifications16)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddProcessingStatus() *model.ProcessingStatus37Choice {
	s.ProcessingStatus = new(model.ProcessingStatus37Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddInferredMatchingStatus() *model.MatchingStatus19Choice {
	s.InferredMatchingStatus = new(model.MatchingStatus19Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddMatchingStatus() *model.MatchingStatus19Choice {
	s.MatchingStatus = new(model.MatchingStatus19Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddSettlementStatus() *model.SettlementStatus7Choice {
	s.SettlementStatus = new(model.SettlementStatus7Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddTransactionDetails() *model.TransactionDetails61 {
	s.TransactionDetails = new(model.TransactionDetails61)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddSupplementaryData() *model.SupplementaryData1 {
