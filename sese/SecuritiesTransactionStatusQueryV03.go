...
type SecuritiesTransactionStatusQueryV03 struct {
	...
	StatusAdviceRequested *model.DocumentNumber9 `xml:"StsAdvcReqd"`
...
func (s *SecuritiesTransactionStatusQueryV03) AddStatusAdviceRequested() *model.DocumentNumber9 {
	s.StatusAdviceRequested = new(model.DocumentNumber9)
	return s.StatusAdviceRequested
}

func (s *SecuritiesTransactionStatusQueryV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionStatusQueryV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionStatusQueryV03) AddSupplementaryData() *model.SupplementaryData1 {
