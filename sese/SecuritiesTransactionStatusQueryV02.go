...
type SecuritiesTransactionStatusQueryV02 struct {
	...
	StatusAdviceRequested *model.DocumentNumber5 `xml:"StsAdvcReqd"`
...
func (s *SecuritiesTransactionStatusQueryV02) AddStatusAdviceRequested() *model.DocumentNumber5 {
	s.StatusAdviceRequested = new(model.DocumentNumber5)
	return s.StatusAdviceRequested
}

func (s *SecuritiesTransactionStatusQueryV02) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionStatusQueryV02) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionStatusQueryV02) AddSupplementaryData() *model.SupplementaryData1 {
