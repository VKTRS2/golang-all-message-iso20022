...
type SecuritiesSettlementTransactionInstruction002V07 struct {
	...
	SettlementTypeAndAdditionalParameters *model.SettlementTypeAndAdditionalParameters20 `xml:"SttlmTpAndAddtlParams"`
	...
	SettlementParameters *model.SettlementDetails132 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionInstruction002V07) AddSettlementTypeAndAdditionalParameters() *model.SettlementTypeAndAdditionalParameters20 {
	s.SettlementTypeAndAdditionalParameters = new(model.SettlementTypeAndAdditionalParameters20)
	return s.SettlementTypeAndAdditionalParameters
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddNumberCounts() *model.NumberCount1Choice {
	s.NumberCounts = new(model.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddLinkages() *model.Linkages43 {
...
func (s *SecuritiesSettlementTransactionInstruction002V07) AddTradeDetails() *model.SecuritiesTradeDetails63 {
	s.TradeDetails = new(model.SecuritiesTradeDetails63)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddQuantityAndAccountDetails() *model.QuantityAndAccount56 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount56)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddSettlementParameters() *model.SettlementDetails132 {
	s.SettlementParameters = new(model.SettlementDetails132)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionInstruction002V07) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddCashParties() *model.CashParties30 {
	s.CashParties = new(model.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddSettlementAmount() *model.AmountAndDirection60 {
	s.SettlementAmount = new(model.AmountAndDirection60)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddOtherAmounts() *model.OtherAmounts35 {
	s.OtherAmounts = new(model.OtherAmounts35)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddOtherBusinessParties() *model.OtherParties29 {
	s.OtherBusinessParties = new(model.OtherParties29)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionInstruction002V07) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters5 {
...
func (s *SecuritiesSettlementTransactionInstruction002V07) AddSupplementaryData() *model.SupplementaryData1 {
