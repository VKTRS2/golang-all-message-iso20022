...
type TransferOutInstructionV03 struct {
	...
	TransferDetails []*model.Transfer11 `xml:"TrfDtls"`

	// Information related to the account from which the financial instrument is to be withdrawn.
	AccountDetails *model.InvestmentAccount22 `xml:"AcctDtls"`

	// Information related to the receiving side of the transfer.
	SettlementDetails *model.ReceiveInformation5 `xml:"SttlmDtls"`
...
func (t *TransferOutInstructionV03) AddMessageIdentification() *model.MessageIdentification1 {
	t.MessageIdentification = new(model.MessageIdentification1)
	return t.MessageIdentification
}

func (t *TransferOutInstructionV03) AddPoolReference() *model.AdditionalReference2 {
	t.PoolReference = new(model.AdditionalReference2)
	return t.PoolReference
}

func (t *TransferOutInstructionV03) AddPreviousReference() *model.AdditionalReference2 {
	t.PreviousReference = new(model.AdditionalReference2)
	return t.PreviousReference
}

func (t *TransferOutInstructionV03) AddRelatedReference() *model.AdditionalReference2 {
...
func (t *TransferOutInstructionV03) AddRequestedTransferDate() *model.DateFormat1Choice {
	t.RequestedTransferDate = new(model.DateFormat1Choice)
	return t.RequestedTransferDate
}

func (t *TransferOutInstructionV03) AddTransferDetails() *model.Transfer11 {
	newValue := new(model.Transfer11)
...
func (t *TransferOutInstructionV03) AddAccountDetails() *model.InvestmentAccount22 {
	t.AccountDetails = new(model.InvestmentAccount22)
	return t.AccountDetails
}

func (t *TransferOutInstructionV03) AddSettlementDetails() *model.ReceiveInformation5 {
	t.SettlementDetails = new(model.ReceiveInformation5)
	return t.SettlementDetails
}

func (t *TransferOutInstructionV03) AddCopyDetails() *model.CopyInformation2 {
	t.CopyDetails = new(model.CopyInformation2)
	return t.CopyDetails
}

func (t *TransferOutInstructionV03) AddExtension() *model.Extension1 {
