...
func (s *SecuritiesTransactionCancellationRequestV03) AddAccountOwnerTransactionIdentification() *model.References2Choice {
...
func (s *SecuritiesTransactionCancellationRequestV03) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionCancellationRequestV03) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionCancellationRequestV03) AddTransactionDetails() *model.TransactionDetails29 {
	s.TransactionDetails = new(model.TransactionDetails29)
	return s.TransactionDetails
}

func (s *SecuritiesTransactionCancellationRequestV03) AddFXCancellation() *model.FXCancellation1Choice {
	s.FXCancellation = new(model.FXCancellation1Choice)
	return s.FXCancellation
}

func (s *SecuritiesTransactionCancellationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
