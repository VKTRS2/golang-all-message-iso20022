...
type SecuritiesSettlementTransactionModificationRequestV02 struct {
	...
	UpdateType []*model.UpdateType9Choice `xml:"UpdTp"`
}

func (s *SecuritiesSettlementTransactionModificationRequestV02) AddModifiedTransactionDetails() *model.TransactionDetails41 {
	s.ModifiedTransactionDetails = new(model.TransactionDetails41)
	return s.ModifiedTransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestV02) AddUpdateType() *model.UpdateType9Choice {
	newValue := new(model.UpdateType9Choice)
