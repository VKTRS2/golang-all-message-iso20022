...
type SecuritiesSettlementConditionsModificationRequestV05 struct {
	...
	RequestDetails []*model.RequestDetails13 `xml:"ReqDtls"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	AdditionalInformation []*model.AdditionalInformation9 `xml:"AddtlInf,omitempty"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (s *SecuritiesSettlementConditionsModificationRequestV05) AddAccountOwner() *model.PartyIdentification36Choice {
	s.AccountOwner = new(model.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequestV05) AddSafekeepingAccount() *model.SecuritiesAccount13 {
	s.SafekeepingAccount = new(model.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequestV05) AddRequestDetails() *model.RequestDetails13 {
	newValue := new(model.RequestDetails13)
...
func (s *SecuritiesSettlementConditionsModificationRequestV05) AddAdditionalInformation() *model.AdditionalInformation9 {
	newValue := new(model.AdditionalInformation9)
...
func (s *SecuritiesSettlementConditionsModificationRequestV05) AddSupplementaryData() *model.SupplementaryData1 {
