...
type SecuritiesFinancingModificationInstruction002V05 struct {
	...
	TransactionTypeAndModificationAdditionalParameters *model.TransactionTypeAndAdditionalParameters14 `xml:"TxTpAndModAddtlParams"`
	...
	QuantityAndAccountDetails *model.QuantityAndAccount48 `xml:"QtyAndAcctDtls"`
...
func (s *SecuritiesFinancingModificationInstruction002V05) AddTransactionTypeAndModificationAdditionalParameters() *model.TransactionTypeAndAdditionalParameters14 {
	s.TransactionTypeAndModificationAdditionalParameters = new(model.TransactionTypeAndAdditionalParameters14)
	return s.TransactionTypeAndModificationAdditionalParameters
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddTradeDetails() *model.SecuritiesTradeDetails12 {
	s.TradeDetails = new(model.SecuritiesTradeDetails12)
	return s.TradeDetails
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddQuantityAndAccountDetails() *model.QuantityAndAccount48 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount48)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddSecuritiesFinancingAdditionalDetails() *model.SecuritiesFinancingTransactionDetails32 {
...
func (s *SecuritiesFinancingModificationInstruction002V05) AddSettlementParameters() *model.SettlementDetails106 {
	s.SettlementParameters = new(model.SettlementDetails106)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddOpeningSettlementAmount() *model.AmountAndDirection66 {
	s.OpeningSettlementAmount = new(model.AmountAndDirection66)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddSupplementaryData() *model.SupplementaryData1 {
