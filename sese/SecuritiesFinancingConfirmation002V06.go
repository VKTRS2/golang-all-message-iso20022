...
type SecuritiesFinancingConfirmation002V06 struct {
	...
	TransactionIdentificationDetails *model.TransactionTypeAndAdditionalParameters12 `xml:"TxIdDtls"`
	...
	QuantityAndAccountDetails *model.QuantityAndAccount46 `xml:"QtyAndAcctDtls"`
...
func (s *SecuritiesFinancingConfirmation002V06) AddTransactionIdentificationDetails() *model.TransactionTypeAndAdditionalParameters12 {
	s.TransactionIdentificationDetails = new(model.TransactionTypeAndAdditionalParameters12)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesFinancingConfirmation002V06) AddAdditionalParameters() *model.AdditionalParameters26 {
	s.AdditionalParameters = new(model.AdditionalParameters26)
	return s.AdditionalParameters
}

func (s *SecuritiesFinancingConfirmation002V06) AddTradeDetails() *model.SecuritiesTradeDetails58 {
	s.TradeDetails = new(model.SecuritiesTradeDetails58)
	return s.TradeDetails
}

func (s *SecuritiesFinancingConfirmation002V06) AddFinancialInstrumentIdentification() *model.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesFinancingConfirmation002V06) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesFinancingConfirmation002V06) AddQuantityAndAccountDetails() *model.QuantityAndAccount46 {
	s.QuantityAndAccountDetails = new(model.QuantityAndAccount46)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingConfirmation002V06) AddSecuritiesFinancingDetails() *model.SecuritiesFinancingTransactionDetails30 {
	s.SecuritiesFinancingDetails = new(model.SecuritiesFinancingTransactionDetails30)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesFinancingConfirmation002V06) AddStandingSettlementInstructionDetails() *model.StandingSettlementInstruction12 {
...
func (s *SecuritiesFinancingConfirmation002V06) AddSettlementParameters() *model.SettlementDetails104 {
	s.SettlementParameters = new(model.SettlementDetails104)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingConfirmation002V06) AddDeliveringSettlementParties() *model.SettlementParties44 {
	s.DeliveringSettlementParties = new(model.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingConfirmation002V06) AddReceivingSettlementParties() *model.SettlementParties44 {
	s.ReceivingSettlementParties = new(model.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingConfirmation002V06) AddCashParties() *model.CashParties30 {
	s.CashParties = new(model.CashParties30)
	return s.CashParties
}

func (s *SecuritiesFinancingConfirmation002V06) AddSettledAmount() *model.AmountAndDirection60 {
	s.SettledAmount = new(model.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesFinancingConfirmation002V06) AddOtherAmounts() *model.OtherAmounts34 {
	s.OtherAmounts = new(model.OtherAmounts34)
	return s.OtherAmounts
}

func (s *SecuritiesFinancingConfirmation002V06) AddOtherBusinessParties() *model.OtherParties29 {
	s.OtherBusinessParties = new(model.OtherParties29)
	return s.OtherBusinessParties
}

func (s *SecuritiesFinancingConfirmation002V06) AddSupplementaryData() *model.SupplementaryData1 {
