...
type SecuritiesSettlementTransactionGenerationNotificationV07 struct {
	...
	TradeDetails *model.SecuritiesTradeDetails67 `xml:"TradDtls"`
	...
	SettlementParameters *model.SettlementDetails120 `xml:"SttlmParams"`
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddTransactionIdentificationDetails() *model.SettlementTypeAndIdentification19 {
	s.TransactionIdentificationDetails = new(model.SettlementTypeAndIdentification19)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddNumberCounts() *model.NumberCount1Choice {
	s.NumberCounts = new(model.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddLinkages() *model.Linkages37 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddTradeDetails() *model.SecuritiesTradeDetails67 {
	s.TradeDetails = new(model.SecuritiesTradeDetails67)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddFinancialInstrumentIdentification() *model.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(model.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddFinancialInstrumentAttributes() *model.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(model.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddQuantityAndAccountDetails() *model.QuantityAndAccount39 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSettlementParameters() *model.SettlementDetails120 {
	s.SettlementParameters = new(model.SettlementDetails120)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddDeliveringSettlementParties() *model.SettlementParties36 {
	s.DeliveringSettlementParties = new(model.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddReceivingSettlementParties() *model.SettlementParties36 {
	s.ReceivingSettlementParties = new(model.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddCashParties() *model.CashParties26 {
	s.CashParties = new(model.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSettlementAmount() *model.AmountAndDirection46 {
	s.SettlementAmount = new(model.AmountAndDirection46)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddOtherAmounts() *model.OtherAmounts28 {
	s.OtherAmounts = new(model.OtherAmounts28)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddOtherBusinessParties() *model.OtherParties27 {
	s.OtherBusinessParties = new(model.OtherParties27)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddAdditionalPhysicalOrRegistrationDetails() *model.RegistrationParameters4 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddGeneratedReason() *model.GeneratedReason5 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddStatusAndReason() *model.StatusAndReason28 {
	s.StatusAndReason = new(model.StatusAndReason28)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSupplementaryData() *model.SupplementaryData1 {
