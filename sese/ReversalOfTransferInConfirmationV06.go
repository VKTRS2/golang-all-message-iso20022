...
type ReversalOfTransferInConfirmationV06 struct {
	...
	Reversal *model.Reversal6Choice `xml:"Rvsl"`
...
func (r *ReversalOfTransferInConfirmationV06) AddMessageIdentification() *model.MessageIdentification1 {
	r.MessageIdentification = new(model.MessageIdentification1)
	return r.MessageIdentification
}

func (r *ReversalOfTransferInConfirmationV06) AddReferences() *model.References15 {
...
func (r *ReversalOfTransferInConfirmationV06) AddReversal() *model.Reversal6Choice {
	r.Reversal = new(model.Reversal6Choice)
	return r.Reversal
}

func (r *ReversalOfTransferInConfirmationV06) AddMarketPracticeVersion() *model.MarketPracticeVersion1 {
	r.MarketPracticeVersion = new(model.MarketPracticeVersion1)
	return r.MarketPracticeVersion
}

func (r *ReversalOfTransferInConfirmationV06) AddCopyDetails() *model.CopyInformation2 {
