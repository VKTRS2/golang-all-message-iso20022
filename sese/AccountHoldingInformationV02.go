...
type AccountHoldingInformationV02 struct {
	...
	ProductTransfer []*model.ISATransfer4 `xml:"PdctTrf"`

	// Additional information that can not be captured in the structured fields and/or any other specific block.
	Extension []*model.Extension1 `xml:"Xtnsn,omitempty"`
}

func (a *AccountHoldingInformationV02) AddMessageReference() *model.MessageIdentification1 {
	a.MessageReference = new(model.MessageIdentification1)
	return a.MessageReference
}

func (a *AccountHoldingInformationV02) AddPoolReference() *model.AdditionalReference3 {
	a.PoolReference = new(model.AdditionalReference3)
	return a.PoolReference
}

func (a *AccountHoldingInformationV02) AddPreviousReference() *model.AdditionalReference3 {
	a.PreviousReference = new(model.AdditionalReference3)
	return a.PreviousReference
}

func (a *AccountHoldingInformationV02) AddRelatedReference() *model.AdditionalReference3 {
...
func (a *AccountHoldingInformationV02) AddPrimaryIndividualInvestor() *model.IndividualPerson8 {
	a.PrimaryIndividualInvestor = new(model.IndividualPerson8)
	return a.PrimaryIndividualInvestor
}

func (a *AccountHoldingInformationV02) AddSecondaryIndividualInvestor() *model.IndividualPerson8 {
	a.SecondaryIndividualInvestor = new(model.IndividualPerson8)
	return a.SecondaryIndividualInvestor
}

func (a *AccountHoldingInformationV02) AddOtherIndividualInvestor() *model.IndividualPerson8 {
...
func (a *AccountHoldingInformationV02) AddPrimaryCorporateInvestor() *model.Organisation4 {
	a.PrimaryCorporateInvestor = new(model.Organisation4)
	return a.PrimaryCorporateInvestor
}

func (a *AccountHoldingInformationV02) AddSecondaryCorporateInvestor() *model.Organisation4 {
	a.SecondaryCorporateInvestor = new(model.Organisation4)
	return a.SecondaryCorporateInvestor
}

func (a *AccountHoldingInformationV02) AddOtherCorporateInvestor() *model.Organisation4 {
...
func (a *AccountHoldingInformationV02) AddTransferorAccount() *model.Account5 {
	a.TransferorAccount = new(model.Account5)
	return a.TransferorAccount
}

func (a *AccountHoldingInformationV02) AddNomineeAccount() *model.Account6 {
	a.NomineeAccount = new(model.Account6)
	return a.NomineeAccount
}

func (a *AccountHoldingInformationV02) AddTransferee() *model.PartyIdentification2Choice {
	a.Transferee = new(model.PartyIdentification2Choice)
	return a.Transferee
}

func (a *AccountHoldingInformationV02) AddProductTransfer() *model.ISATransfer4 {
	newValue := new(model.ISATransfer4)
...
func (a *AccountHoldingInformationV02) AddExtension() *model.Extension1 {
