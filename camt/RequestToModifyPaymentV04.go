...
type RequestToModifyPaymentV04 struct {
	...
	Modification *model.RequestedModification6 `xml:"Mod"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (r *RequestToModifyPaymentV04) AddAssignment() *model.CaseAssignment3 {
	r.Assignment = new(model.CaseAssignment3)
	return r.Assignment
}

func (r *RequestToModifyPaymentV04) AddCase() *model.Case3 {
	r.Case = new(model.Case3)
	return r.Case
}

func (r *RequestToModifyPaymentV04) AddUnderlying() *model.UnderlyingTransaction3Choice {
	r.Underlying = new(model.UnderlyingTransaction3Choice)
	return r.Underlying
}

func (r *RequestToModifyPaymentV04) AddModification() *model.RequestedModification6 {
	r.Modification = new(model.RequestedModification6)
	return r.Modification
}

func (r *RequestToModifyPaymentV04) AddSupplementaryData() *model.SupplementaryData1 {
