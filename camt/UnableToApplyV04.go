...
func (u *UnableToApplyV04) AddAssignment() *model.CaseAssignment3 {
	u.Assignment = new(model.CaseAssignment3)
	return u.Assignment
}

func (u *UnableToApplyV04) AddCase() *model.Case3 {
	u.Case = new(model.Case3)
	return u.Case
}

func (u *UnableToApplyV04) AddUnderlying() *model.UnderlyingTransaction2Choice {
	u.Underlying = new(model.UnderlyingTransaction2Choice)
	return u.Underlying
}

func (u *UnableToApplyV04) AddJustification() *model.UnableToApplyJustification2Choice {
	u.Justification = new(model.UnableToApplyJustification2Choice)
	return u.Justification
}

func (u *UnableToApplyV04) AddSupplementaryData() *model.SupplementaryData1 {
