...
type NotificationToReceiveStatusReportV04 struct {
	...
	OriginalNotificationAndStatus *model.OriginalNotification7 `xml:"OrgnlNtfctnAndSts"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (n *NotificationToReceiveStatusReportV04) AddGroupHeader() *model.GroupHeader60 {
	n.GroupHeader = new(model.GroupHeader60)
	return n.GroupHeader
}

func (n *NotificationToReceiveStatusReportV04) AddOriginalNotificationAndStatus() *model.OriginalNotification7 {
	n.OriginalNotificationAndStatus = new(model.OriginalNotification7)
	return n.OriginalNotificationAndStatus
}

func (n *NotificationToReceiveStatusReportV04) AddSupplementaryData() *model.SupplementaryData1 {
