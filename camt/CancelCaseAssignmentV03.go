...
func (c *CancelCaseAssignmentV03) AddAssignment() *model.CaseAssignment3 {
	c.Assignment = new(model.CaseAssignment3)
	return c.Assignment
}

func (c *CancelCaseAssignmentV03) AddCase() *model.Case3 {
	c.Case = new(model.Case3)
	return c.Case
}

func (c *CancelCaseAssignmentV03) AddSupplementaryData() *model.SupplementaryData1 {
