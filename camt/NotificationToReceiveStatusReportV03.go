...
type NotificationToReceiveStatusReportV03 struct {
	...
	OriginalNotificationAndStatus *model.OriginalNotification5 `xml:"OrgnlNtfctnAndSts"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (n *NotificationToReceiveStatusReportV03) AddGroupHeader() *model.GroupHeader60 {
	n.GroupHeader = new(model.GroupHeader60)
	return n.GroupHeader
}

func (n *NotificationToReceiveStatusReportV03) AddOriginalNotificationAndStatus() *model.OriginalNotification5 {
	n.OriginalNotificationAndStatus = new(model.OriginalNotification5)
	return n.OriginalNotificationAndStatus
}

func (n *NotificationToReceiveStatusReportV03) AddSupplementaryData() *model.SupplementaryData1 {
