...
type FIToFIPaymentCancellationRequestV05 struct {
	...
	Underlying []*model.UnderlyingTransaction13 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentCancellationRequestV05) AddAssignment() *model.CaseAssignment3 {
	f.Assignment = new(model.CaseAssignment3)
	return f.Assignment
}

func (f *FIToFIPaymentCancellationRequestV05) AddCase() *model.Case3 {
	f.Case = new(model.Case3)
	return f.Case
}

func (f *FIToFIPaymentCancellationRequestV05) AddControlData() *model.ControlData1 {
	f.ControlData = new(model.ControlData1)
	return f.ControlData
}

func (f *FIToFIPaymentCancellationRequestV05) AddUnderlying() *model.UnderlyingTransaction13 {
	newValue := new(model.UnderlyingTransaction13)
...
func (f *FIToFIPaymentCancellationRequestV05) AddSupplementaryData() *model.SupplementaryData1 {
