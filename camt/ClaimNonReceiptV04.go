...
func (c *ClaimNonReceiptV04) AddAssignment() *model.CaseAssignment3 {
	c.Assignment = new(model.CaseAssignment3)
	return c.Assignment
}

func (c *ClaimNonReceiptV04) AddCase() *model.Case3 {
	c.Case = new(model.Case3)
	return c.Case
}

func (c *ClaimNonReceiptV04) AddUnderlying() *model.UnderlyingTransaction2Choice {
	c.Underlying = new(model.UnderlyingTransaction2Choice)
	return c.Underlying
}

func (c *ClaimNonReceiptV04) AddCoverDetails() *model.MissingCover3 {
	c.CoverDetails = new(model.MissingCover3)
	return c.CoverDetails
}

func (c *ClaimNonReceiptV04) AddSupplementaryData() *model.SupplementaryData1 {
