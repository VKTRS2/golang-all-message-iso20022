...
type AdditionalPaymentInformationV04 struct {
	...
	Information *model.PaymentComplementaryInformation3 `xml:"Inf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (a *AdditionalPaymentInformationV04) AddAssignment() *model.CaseAssignment3 {
	a.Assignment = new(model.CaseAssignment3)
	return a.Assignment
}

func (a *AdditionalPaymentInformationV04) AddCase() *model.Case3 {
	a.Case = new(model.Case3)
	return a.Case
}

func (a *AdditionalPaymentInformationV04) AddUnderlying() *model.UnderlyingTransaction2Choice {
	a.Underlying = new(model.UnderlyingTransaction2Choice)
	return a.Underlying
}

func (a *AdditionalPaymentInformationV04) AddInformation() *model.PaymentComplementaryInformation3 {
	a.Information = new(model.PaymentComplementaryInformation3)
	return a.Information
}

func (a *AdditionalPaymentInformationV04) AddSupplementaryData() *model.SupplementaryData1 {
