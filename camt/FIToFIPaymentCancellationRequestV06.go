...
type FIToFIPaymentCancellationRequestV06 struct {
	...
	Underlying []*model.UnderlyingTransaction16 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentCancellationRequestV06) AddAssignment() *model.CaseAssignment3 {
	f.Assignment = new(model.CaseAssignment3)
	return f.Assignment
}

func (f *FIToFIPaymentCancellationRequestV06) AddCase() *model.Case3 {
	f.Case = new(model.Case3)
	return f.Case
}

func (f *FIToFIPaymentCancellationRequestV06) AddControlData() *model.ControlData1 {
	f.ControlData = new(model.ControlData1)
	return f.ControlData
}

func (f *FIToFIPaymentCancellationRequestV06) AddUnderlying() *model.UnderlyingTransaction16 {
	newValue := new(model.UnderlyingTransaction16)
...
func (f *FIToFIPaymentCancellationRequestV06) AddSupplementaryData() *model.SupplementaryData1 {
