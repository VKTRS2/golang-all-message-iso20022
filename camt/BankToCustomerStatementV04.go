...
type BankToCustomerStatementV04 struct {
	...
	Statement []*model.AccountStatement4 `xml:"Stmt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (b *BankToCustomerStatementV04) AddGroupHeader() *model.GroupHeader58 {
	b.GroupHeader = new(model.GroupHeader58)
	return b.GroupHeader
}

func (b *BankToCustomerStatementV04) AddStatement() *model.AccountStatement4 {
	newValue := new(model.AccountStatement4)
...
func (b *BankToCustomerStatementV04) AddSupplementaryData() *model.SupplementaryData1 {
