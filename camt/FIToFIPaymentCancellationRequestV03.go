...
type FIToFIPaymentCancellationRequestV03 struct {
	...
	Underlying []*model.UnderlyingTransaction8 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentCancellationRequestV03) AddAssignment() *model.CaseAssignment3 {
	f.Assignment = new(model.CaseAssignment3)
	return f.Assignment
}

func (f *FIToFIPaymentCancellationRequestV03) AddCase() *model.Case3 {
	f.Case = new(model.Case3)
	return f.Case
}

func (f *FIToFIPaymentCancellationRequestV03) AddControlData() *model.ControlData1 {
	f.ControlData = new(model.ControlData1)
	return f.ControlData
}

func (f *FIToFIPaymentCancellationRequestV03) AddUnderlying() *model.UnderlyingTransaction8 {
	newValue := new(model.UnderlyingTransaction8)
...
func (f *FIToFIPaymentCancellationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
