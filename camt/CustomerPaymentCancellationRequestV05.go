...
type CustomerPaymentCancellationRequestV05 struct {
	...
	Underlying []*model.UnderlyingTransaction12 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentCancellationRequestV05) AddAssignment() *model.CaseAssignment3 {
	c.Assignment = new(model.CaseAssignment3)
	return c.Assignment
}

func (c *CustomerPaymentCancellationRequestV05) AddCase() *model.Case3 {
	c.Case = new(model.Case3)
	return c.Case
}

func (c *CustomerPaymentCancellationRequestV05) AddControlData() *model.ControlData1 {
	c.ControlData = new(model.ControlData1)
	return c.ControlData
}

func (c *CustomerPaymentCancellationRequestV05) AddUnderlying() *model.UnderlyingTransaction12 {
	newValue := new(model.UnderlyingTransaction12)
...
func (c *CustomerPaymentCancellationRequestV05) AddSupplementaryData() *model.SupplementaryData1 {
