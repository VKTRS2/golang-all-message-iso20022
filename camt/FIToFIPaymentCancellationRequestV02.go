...
type FIToFIPaymentCancellationRequestV02 struct {
	...
	Underlying []*model.UnderlyingTransaction5 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (f *FIToFIPaymentCancellationRequestV02) AddAssignment() *model.CaseAssignment3 {
	f.Assignment = new(model.CaseAssignment3)
	return f.Assignment
}

func (f *FIToFIPaymentCancellationRequestV02) AddCase() *model.Case3 {
	f.Case = new(model.Case3)
	return f.Case
}

func (f *FIToFIPaymentCancellationRequestV02) AddControlData() *model.ControlData1 {
	f.ControlData = new(model.ControlData1)
	return f.ControlData
}

func (f *FIToFIPaymentCancellationRequestV02) AddUnderlying() *model.UnderlyingTransaction5 {
	newValue := new(model.UnderlyingTransaction5)
...
func (f *FIToFIPaymentCancellationRequestV02) AddSupplementaryData() *model.SupplementaryData1 {
