...
type ResolutionOfInvestigationV07 struct {
	...
	CancellationDetails []*model.UnderlyingTransaction17 `xml:"CxlDtls,omitempty"`
	...
	CorrectionTransaction *model.CorrectiveTransaction2Choice `xml:"CrrctnTx,omitempty"`
...
func (r *ResolutionOfInvestigationV07) AddAssignment() *model.CaseAssignment3 {
	r.Assignment = new(model.CaseAssignment3)
	return r.Assignment
}

func (r *ResolutionOfInvestigationV07) AddResolvedCase() *model.Case3 {
	r.ResolvedCase = new(model.Case3)
	return r.ResolvedCase
}

func (r *ResolutionOfInvestigationV07) AddStatus() *model.InvestigationStatus3Choice {
	r.Status = new(model.InvestigationStatus3Choice)
	return r.Status
}

func (r *ResolutionOfInvestigationV07) AddCancellationDetails() *model.UnderlyingTransaction17 {
	newValue := new(model.UnderlyingTransaction17)
...
func (r *ResolutionOfInvestigationV07) AddStatementDetails() *model.StatementResolutionEntry2 {
	r.StatementDetails = new(model.StatementResolutionEntry2)
	return r.StatementDetails
}

func (r *ResolutionOfInvestigationV07) AddCorrectionTransaction() *model.CorrectiveTransaction2Choice {
	r.CorrectionTransaction = new(model.CorrectiveTransaction2Choice)
	return r.CorrectionTransaction
}

func (r *ResolutionOfInvestigationV07) AddResolutionRelatedInformation() *model.ResolutionInformation1 {
	r.ResolutionRelatedInformation = new(model.ResolutionInformation1)
	return r.ResolutionRelatedInformation
}

func (r *ResolutionOfInvestigationV07) AddSupplementaryData() *model.SupplementaryData1 {
