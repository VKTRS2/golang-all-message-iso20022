...
type CustomerPaymentCancellationRequestV03 struct {
	...
	Underlying []*model.UnderlyingTransaction7 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentCancellationRequestV03) AddAssignment() *model.CaseAssignment3 {
	c.Assignment = new(model.CaseAssignment3)
	return c.Assignment
}

func (c *CustomerPaymentCancellationRequestV03) AddCase() *model.Case3 {
	c.Case = new(model.Case3)
	return c.Case
}

func (c *CustomerPaymentCancellationRequestV03) AddControlData() *model.ControlData1 {
	c.ControlData = new(model.ControlData1)
	return c.ControlData
}

func (c *CustomerPaymentCancellationRequestV03) AddUnderlying() *model.UnderlyingTransaction7 {
	newValue := new(model.UnderlyingTransaction7)
...
func (c *CustomerPaymentCancellationRequestV03) AddSupplementaryData() *model.SupplementaryData1 {
