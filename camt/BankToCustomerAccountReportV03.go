...
type BankToCustomerAccountReportV03 struct {
	...
	Report []*model.AccountReport12 `xml:"Rpt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (b *BankToCustomerAccountReportV03) AddGroupHeader() *model.GroupHeader58 {
	b.GroupHeader = new(model.GroupHeader58)
	return b.GroupHeader
}

func (b *BankToCustomerAccountReportV03) AddReport() *model.AccountReport12 {
	newValue := new(model.AccountReport12)
...
func (b *BankToCustomerAccountReportV03) AddSupplementaryData() *model.SupplementaryData1 {
