...
type BankToCustomerStatementV03 struct {
	...
	Statement []*model.AccountStatement3 `xml:"Stmt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (b *BankToCustomerStatementV03) AddGroupHeader() *model.GroupHeader58 {
	b.GroupHeader = new(model.GroupHeader58)
	return b.GroupHeader
}

func (b *BankToCustomerStatementV03) AddStatement() *model.AccountStatement3 {
	newValue := new(model.AccountStatement3)
...
func (b *BankToCustomerStatementV03) AddSupplementaryData() *model.SupplementaryData1 {
