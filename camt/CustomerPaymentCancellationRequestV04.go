...
type CustomerPaymentCancellationRequestV04 struct {
	...
	Underlying []*model.UnderlyingTransaction11 `xml:"Undrlyg"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (c *CustomerPaymentCancellationRequestV04) AddAssignment() *model.CaseAssignment3 {
	c.Assignment = new(model.CaseAssignment3)
	return c.Assignment
}

func (c *CustomerPaymentCancellationRequestV04) AddCase() *model.Case3 {
	c.Case = new(model.Case3)
	return c.Case
}

func (c *CustomerPaymentCancellationRequestV04) AddControlData() *model.ControlData1 {
	c.ControlData = new(model.ControlData1)
	return c.ControlData
}

func (c *CustomerPaymentCancellationRequestV04) AddUnderlying() *model.UnderlyingTransaction11 {
	newValue := new(model.UnderlyingTransaction11)
...
func (c *CustomerPaymentCancellationRequestV04) AddSupplementaryData() *model.SupplementaryData1 {
