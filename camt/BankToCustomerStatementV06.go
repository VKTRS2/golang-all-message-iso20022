...
type BankToCustomerStatementV06 struct {
	...
	Statement []*model.AccountStatement6 `xml:"Stmt"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (b *BankToCustomerStatementV06) AddGroupHeader() *model.GroupHeader58 {
	b.GroupHeader = new(model.GroupHeader58)
	return b.GroupHeader
}

func (b *BankToCustomerStatementV06) AddStatement() *model.AccountStatement6 {
	newValue := new(model.AccountStatement6)
...
func (b *BankToCustomerStatementV06) AddSupplementaryData() *model.SupplementaryData1 {
