...
type AdditionalPaymentInformationV05 struct {
	...
	Information *model.PaymentComplementaryInformation4 `xml:"Inf"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (a *AdditionalPaymentInformationV05) AddAssignment() *model.CaseAssignment3 {
	a.Assignment = new(model.CaseAssignment3)
	return a.Assignment
}

func (a *AdditionalPaymentInformationV05) AddCase() *model.Case3 {
	a.Case = new(model.Case3)
	return a.Case
}

func (a *AdditionalPaymentInformationV05) AddUnderlying() *model.UnderlyingTransaction2Choice {
	a.Underlying = new(model.UnderlyingTransaction2Choice)
	return a.Underlying
}

func (a *AdditionalPaymentInformationV05) AddInformation() *model.PaymentComplementaryInformation4 {
	a.Information = new(model.PaymentComplementaryInformation4)
	return a.Information
}

func (a *AdditionalPaymentInformationV05) AddSupplementaryData() *model.SupplementaryData1 {
