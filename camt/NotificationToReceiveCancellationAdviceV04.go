...
type NotificationToReceiveCancellationAdviceV04 struct {
	...
	OriginalNotification *model.OriginalNotification8 `xml:"OrgnlNtfctn"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (n *NotificationToReceiveCancellationAdviceV04) AddGroupHeader() *model.GroupHeader59 {
	n.GroupHeader = new(model.GroupHeader59)
	return n.GroupHeader
}

func (n *NotificationToReceiveCancellationAdviceV04) AddOriginalNotification() *model.OriginalNotification8 {
	n.OriginalNotification = new(model.OriginalNotification8)
	return n.OriginalNotification
}

func (n *NotificationToReceiveCancellationAdviceV04) AddSupplementaryData() *model.SupplementaryData1 {
