...
type RequestToModifyPaymentV01 struct {
	...
	Modification *model.RequestedModification3 `xml:"Mod"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (r *RequestToModifyPaymentV01) AddAssignment() *model.CaseAssignment3 {
	r.Assignment = new(model.CaseAssignment3)
	return r.Assignment
}

func (r *RequestToModifyPaymentV01) AddCase() *model.Case3 {
	r.Case = new(model.Case3)
	return r.Case
}

func (r *RequestToModifyPaymentV01) AddUnderlying() *model.UnderlyingTransaction2Choice {
	r.Underlying = new(model.UnderlyingTransaction2Choice)
	return r.Underlying
}

func (r *RequestToModifyPaymentV01) AddModification() *model.RequestedModification3 {
	r.Modification = new(model.RequestedModification3)
	return r.Modification
}

func (r *RequestToModifyPaymentV01) AddSupplementaryData() *model.SupplementaryData1 {
