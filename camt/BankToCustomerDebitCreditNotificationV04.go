...
type BankToCustomerDebitCreditNotificationV04 struct {
	...
	Notification []*model.AccountNotification7 `xml:"Ntfctn"`

	// Additional information that cannot be captured in the structured elements and/or any other specific block.
	SupplementaryData []*model.SupplementaryData1 `xml:"SplmtryData,omitempty"`
}

func (b *BankToCustomerDebitCreditNotificationV04) AddGroupHeader() *model.GroupHeader58 {
	b.GroupHeader = new(model.GroupHeader58)
	return b.GroupHeader
}

func (b *BankToCustomerDebitCreditNotificationV04) AddNotification() *model.AccountNotification7 {
	newValue := new(model.AccountNotification7)
...
func (b *BankToCustomerDebitCreditNotificationV04) AddSupplementaryData() *model.SupplementaryData1 {
